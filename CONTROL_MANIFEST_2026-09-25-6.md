# Control manifest — 2026-09-25-6 (canonical-ID assignment re-hash (P-516, P-517))

Method: **MDS-2026.09.19-v4.3**
Control revision: **CR-2026.09.21-3** (label unchanged; content receipt under the same label)
Status: **CURRENT post-write content receipt**, generated 2026-09-26 00:28 AEST by `tools/make_manifest.py` from `CONTROL_MANIFEST_2026-09-25-5.md`.

**Purpose.** This is the byte-level SHA-256 receipt that every new card freezes (`METHOD.md` header; PF-7). Re-hashes CONTROL_MANIFEST_2026-09-25-5.md after the 2026-09-26(a) operator instruction assigning P-516 to TMP-20260923-NPB-CHU-DB-G25 and P-517 to TMP-20260923-NBL-CNS-TAS (README, CHANGELOG, METHOD header, settled-row extractor aliases). No rule, tool behaviour or coefficient changes relative to -5.

**Model change:** None relative to CONTROL_MANIFEST_2026-09-25-5.md. RM-1 (a -0.187, b 1.543, cushion -1.127) remains the user-authorised L-087 exception recorded there; it sets the issued rank order and never changes a stated probability.
...
**Changed since CONTROL_MANIFEST_2026-09-25-5.md (by bytes):** `README.md`, `METHOD.md`, `GAME_LOG_STATUS_CURRENT.md`, `PREDICTION_LOG_COMBINED_5.md`, `CHANGELOG.md`, `research/settled_rows_2026-09-25/extract_settled_rows.py`.
...
| File | SHA-256 | Bytes |
|---|---|---:|
| `README.md` | `889ab473ccf522bc6fd1a79a3ac72655a075b6752441168ecdd64770ad6979c0` | 10615 |
| `METHOD.md` | `045abe9d4eb7558c18746c6b8c397b7a4b22d0598065c53c404e6f725b325fb8` | 29201 |
...
| `CHANGELOG.md` | `d8241e1fda0796689f85b13acbeff1b2db377cf083196c98a03609eeeeb055c1` | 32994 |
