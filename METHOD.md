...
Control revision: **CR-2026.09.21-3** — preserves CR-2026.09.21-2 and removes residual live-rule/version/queue drift found by post-reconciliation read-back. Freeze the SHA-256 file receipt from [CONTROL_MANIFEST_2026-09-25-2.md](CONTROL_MANIFEST_2026-09-25-2.md) with every new card. It is the post-research-pass content receipt under the same control revision, and it adds the 2026-09-25(b) reference, width and receipt controls to the 2026-09-24(f) and 2026-09-25 integrity controls. [CONTROL_MANIFEST_2026-09-25.md](CONTROL_MANIFEST_2026-09-25.md) was the receipt from the audit closure until the research pass (no card was issued under it); [CONTROL_MANIFEST_2026-09-23.md](CONTROL_MANIFEST_2026-09-23.md) remains the receipt for P-495–P-509; [CONTROL_MANIFEST_2026-09-21-3.md](CONTROL_MANIFEST_2026-09-21-3.md) for cards issued before 2026-09-23 about 22:00 AEST.
