...
Control revision: **CR-2026.09.21-3** — preserves CR-2026.09.21-2 and removes residual live-rule/version/queue drift found by post-reconciliation read-back. Freeze the SHA-256 file receipt from [CONTROL_MANIFEST_2026-09-25-3.md](CONTROL_MANIFEST_2026-09-25-3.md) with every new card. It is the post-repository-review content receipt under the same control revision. It adds the 2026-09-25(c) baseline-skill, current-rules and repository controls to the 2026-09-25(b) reference, width and receipt controls and the 2026-09-24(f)/2026-09-25 integrity controls. Verify it with `python tools/verify_manifest.py`. [CONTROL_MANIFEST_2026-09-25-2.md](CONTROL_MANIFEST_2026-09-25-2.md) and [CONTROL_MANIFEST_2026-09-25.md](CONTROL_MANIFEST_2026-09-25.md) were the receipts of the research pass and the audit closure (no card was issued under either); [CONTROL_MANIFEST_2026-09-23.md](CONTROL_MANIFEST_2026-09-23.md) remains the receipt for P-495–P-509; [CONTROL_MANIFEST_2026-09-21-3.md](CONTROL_MANIFEST_2026-09-21-3.md) for cards issued before 2026-09-23 about 22:00 AEST.
...
| **4 Contract queries and ranks** | Exact W/P/L and any action conditioning; q(non-push) separately if defined; distribution reference; rank derived from stated objective; FORCED_PAIR/FREE, frozen preferred side, all considered alternate lines; component/separation budgets and sign checks; no numerical row cap disconnected from the distribution. **From 2026-09-25(c):** print `BASELINE_P` beside each ranked row: the naive, leak-free population probability of the same contract, or `NOT_YET_DERIVED` (`C-BASELINE-SKILL`; `SKILL_BASELINE_LEDGER.md`). |
