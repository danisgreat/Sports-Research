...
9. **MLB cards may add a shadow row** (`python tools/mlb_model.py shadow --gamepk <pk> --total <line> --card P-<n>`), frozen before first pitch. It is never a card input and never changes a rank.
