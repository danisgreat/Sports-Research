...
| `BS-A1-TEAM-v2` (MLB and NPB/KBO/CPBL) | Team + park + home core of `BS-A1-JOINT-RUN-v0` | Shared-gamma joint; team prior 120 games (v1: 20); competition tie rate kept where ties exist | **TUNED** (2022) then scored 2023–24 (not independent); SHADOW (`C-MLB-SHADOW`; Asian leagues via CSV) | v1 failed (overconfident); v2 better than A0, level with TB-1 on results; the independent 2025 test replicated (A1 − A0 −0.0023 [−0.0042, −0.0005], 2026-09-26(e), `T-MLB-V2-2025`) |
