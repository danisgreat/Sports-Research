...
**Predictability (2026-09-26(e)).** In the NHL 2025-26, the model's favourite reached 0.70 in only 6% of games (won 72.9%), and 67% of games sat at 0.50–0.60 (Brier 0.248 against 0.250). Totals are not predictable by any model here: A1 was worse than the population, and TB-1 no better. A STRONG NHL Rank 1 is rare (`research/predictability_2026-09-26/README.md`; `BASE_RATES_REGISTER.md` §7.8).
