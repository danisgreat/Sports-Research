...
const list=JSON.parse(await fs.readFile(new URL('source_requests_d.json',root),'utf8'));
...
await fs.writeFile(new URL('source_receipts_d.json',root),JSON.stringify(results,null,2));
