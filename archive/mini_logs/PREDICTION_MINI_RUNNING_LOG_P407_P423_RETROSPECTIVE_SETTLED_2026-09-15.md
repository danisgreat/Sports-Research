...
**Status:** **2026-09-15 — SETTLED, RETROSPECTED, CANONICALLY IMPORTED into `PREDICTION_LOG_COMBINED_3.md` §"2026-09-15(b)" and ARCHIVED.**
- **Final / settled:** P-408, P-411–P-414, P-416, P-417, P-420–P-423.
- **Final but partial** (corner row provisional): P-407, P-409, P-410, P-419.
- **Open (identity conflict):** P-418.
- **Not issued:** P-415.
- **No event is live.** Next canonical ID P-424.

*(Previous status: ACTIVE LOCAL WORKING LOG.)*  
...
#### 2026-09-15 settlement and retrospective — P-407 (FINAL / PARTIAL)

**Final:** Club Brugge 3–1 Royal Antwerp (goals 13', 19', 50', 78'; shots 23–17, on target 9–5; corners 9–4). **Source:** ESPN `soccer/bel.1` event 401878991. **Population:** EXPLORATORY.

| Rank | Contract | `p` | Result | Brier | Note |
|---:|---|---:|---|---:|---|
| 1 | Club Brugge team corners Over 4.5 | 0.78 | **PROVISIONAL WIN — not booked** | — | ESPN (Opta lineage) 9; the card's named provider (Pro League match centre) was not reached — `TMP-OPEN-20260915-01` |
| 2 | Royal Antwerp team goals Under 1.5 | 0.74 | **WIN** | 0.0676 | 1 goal |
| 3 | 1st Half total goals Over 0.5 | 0.72 | **WIN** | 0.0784 | 13' |
| 4 | Full match Under 3.5 | 0.68 | **LOSS** | 0.4624 | 4 goals |
| 5 | Full match Over 2.5 | 0.56 | **WIN** | 0.1936 | 4 goals |

**Potential winner:** Club Brugge 60% — **CORRECT**. **Card mean Brier (4 graded):** 0.2005.

**Retrospective:**
- *Driver:* Brugge's chance volume and an early goal took the match to four goals.
- *What went right, and why:* the goal-process rows and the winner, built on current shots and xG rather than the five-game streak.
- *What went wrong:* Under 3.5 was ranked above Over 2.5; both win only on exactly three goals, and four killed the higher row.
...
- *Line-ups:* XIs not retrieved (probable only); bench not retrieved; coaches not named. Answer **No** (`PUBLICATION_TIME_UNVERIFIED`).
- *Sources:* accurate; the conflicting absence reports were preserved, not merged.
- *Blind spot:* the overlapping-total exact-three state.
...
#### 2026-09-15 settlement and retrospective — P-408 (FINAL / SETTLED; PRIMARY_SCORED EPL) — Rank #1 lost

**Final:** Coventry City 0–5 Brighton (goals 35', 51', 70', 83', 90+4'; possession 31–69; shots 14–22). **Sources:** Premier League official data (fixture 128956: `won_corners` Brighton 3, Coventry 5) — the field owner; ESPN `soccer/eng.1` 401879282 agrees.

| Rank | Contract | `p` | Result | Brier | Note |
|---:|---|---:|---|---:|---|
| 1 | Brighton team corners Over 3.5 | 0.75 | **LOSS** | 0.5625 | 3 at the Premier League record — lost by 0.5 |
| 2 | Brighton or Draw (90 min) | 0.74 | **WIN** | 0.0676 | Brighton won |
| 3 | 1st Half total goals Over 0.5 | 0.72 | **WIN** | 0.0784 | 35' |
| 4 | Coventry team goals Under 1.5 | 0.68 | **WIN** | 0.1024 | 0 |
| 5 | Full match Over 2.5 | 0.55 | **WIN** | 0.2025 | 5 goals |

**Potential winner:** Brighton 48% — **CORRECT**. **Card mean Brier:** 0.2027.

**Deep Rank-#1 retrospective:**

| Question | Finding |
|---|---|
| First decisive checkpoint | Full time: 3 Brighton corners |
| What went right | Ranks 2–5 and the winner; both XIs and full benches captured; an honest n = 3 standard error printed |
| What went wrong | A 75% corner row on a three-game sample, although the card itself said Brighton had lost Mitoma and Minteh (their natural width) and that an early lead cuts later territory. The centre was trimmed only from 6.3 to 5.4 |
| Actual mechanism | Brighton led from 35', held 69% possession and took 22 shots, but won only 3 corners — central combination play plus a leading state |
| Knowable, and on the card? | Yes — both kill paths were printed inside a 25% complement |
| Improvement | Soccer control 33: recompute the corner centre from the players who generate corners, and give the leading-state branch its own mass. Links `G-L7`, `G-L9`, soccer controls 4 and 21 |
| Grade | C |

**Validation questions:**
- *Line-ups:* both XIs and full benches yes; coaches not named. Answer **No**.
- *Sources:* accurate; the new Premier League data record is the field owner.
- *Blind spot:* personnel-driven corner generation.
...
#### 2026-09-15 settlement and retrospective — P-409 (FINAL / PARTIAL)

**Final:** Lille 2–0 Troyes (18', 90+3'; corners Lille 2, Troyes 5). **Source:** ESPN `soccer/fra.1` event 401876462.

| Rank | Contract | `p` | Result | Brier | Note |
|---:|---|---:|---|---:|---|
| 1 | Lille team goals Over 0.5 | 0.82 | **WIN** | 0.0324 | 2 |
| 2 | Troyes team corners Over 2.5 | 0.79 | **PROVISIONAL WIN — not booked** | — | ESPN 5; LFP record not reached — `TMP-OPEN-20260915-02` |
| 3 | Lille or Draw (90 min) | 0.76 | **WIN** | 0.0576 | Lille won |
| 4 | 1st Half total goals Over 0.5 | 0.70 | **WIN** | 0.0900 | 18' |
| 5 | Full match Under 3.5 | 0.65 | **WIN** | 0.1225 | 2 goals |

**Potential winner:** Lille 51% — **CORRECT**. **Card mean Brier (4 graded):** 0.0756.

**Retrospective:**
- Every row landed. *What went right, and why:* a direct corner process for the underdog (Troyes 6/5/11 corners for) instead of possession as a proxy.
- The unranked Over 2.5 (57%) lost, and the card correctly kept it out of the top five.

**Validation questions:**
- *Line-ups:* XIs not retrieved; coaches not named. Answer **No**.
- *Sources:* accurate. *Blind spot:* none material.
...
#### 2026-09-15 settlement and retrospective — P-410 (FINAL / PARTIAL)

**Final:** RB Leipzig 5–0 Hamburger SV (17', 28', 72', 74', 77'; corners 8–7). **Source:** ESPN `soccer/ger.1` event 401884798.
...
| 4 | 1st Half total goals Over 0.5 | 0.76 | **WIN** | 0.0576 | 17' |
| 5 | RB Leipzig team corners Over 4.5 | 0.68 | **PROVISIONAL WIN — not booked** | — | ESPN 8; DFL/Bundesliga record not reached — `TMP-OPEN-20260915-03` |

**Potential winner:** RB Leipzig 64% — **CORRECT**. **Card mean Brier (4 graded):** 0.0310.

**Retrospective:**
- *What went right, and why:* xG suppression of HSV (0.89 xG in two games) and current first-half evidence; the unranked Over 2.5 (59%) also won.
...
#### 2026-09-15 settlement and retrospective — P-411 (FINAL / SETTLED) — Rank #1 lost

**Final:** Spain (W) 81–58 Germany (W) (quarters 25-15, 15-21, 21-15, 20-7; no overtime; Spain's biggest lead 26; Germany 31.8% from three). **Source:** FIBA game 128154-ESP-GER.
...
**Potential winner:** Spain 60% — **CORRECT**. **Card mean Brier:** 0.2672.

**Deep Rank-#1 retrospective:**

| Question | Finding |
|---|---|
| First decisive checkpoint | Q4 20–7 (61–51 after three quarters) |
| What went right | Under 147.5 and the winner; final 12s; availability (Peterson's illness correctly treated as resolved) |
| What went wrong | The card set aside the same-tournament meeting ten days earlier (Spain 83–53) as an extreme-shooting outlier and centred Spain at +5.2 |
| Actual mechanism | Spain's pressure and a 15–0 run; +23 |
| Knowable, and on the card? | Yes — "Spain pressure recreates the opener's separation" was the first kill path, inside a 44% complement |
| Improvement | Basketball control 25 (a same-competition, same-roster meeting is current evidence to decompose, not discard); `G-L12`. Mirror case: P-371 |
| Grade | C |

**Validation questions:**
- *Line-ups:* starting fives not confirmed; final 12s yes; coaches not named. Answer **No**.
- *Sources:* accurate.
- *Blind spot:* discarding the most relevant current evidence.
...
#### 2026-09-15 settlement and retrospective — P-412 (FINAL / SETTLED) — Rank #1 lost

**Final:** Pittsburgh Steelers 20–13 Atlanta Falcons (no overtime). **Source:** ESPN NFL event 401872658.

| Rank | Contract | `p` | Result | Brier | Note |
|---:|---|---:|---|---:|---|
| 1 | Atlanta Falcons +6.5 | 0.55 | **LOSS** | 0.3025 | lost by exactly 7 |
| 2 | Under 40.5 | 0.53 | **WIN** | 0.2209 | 33 |
| 3 | Over 40.5 | 0.47 | **LOSS** | 0.2209 | 33 |
| 4 | Pittsburgh Steelers −6.5 | 0.45 | **WIN** | 0.3025 | won by 7 |

**Potential winner:** Pittsburgh 66% — **CORRECT**. **Card mean Brier:** 0.2617.

**Deep Rank-#1 retrospective:** the checkpoint was full time, a seven-point margin.
- *What went right:* Under 40.5, the winner, and the quarterback/injury state.
- *What went wrong:* this 23-line card printed no margin-family table and no key-number mass.
- *Knowable?* Partly — the centre (PIT ≈ +6) sat near the line, so this is a half-point boundary loss at the most important NFL margin after 3.
- *Improvement:* American football control 18 — print the masses at exactly 3 and 7; a card without a margin table caps its handicap at `FORCED RANK` (`G-L1`). Grade C+ (boundary).

**Validation questions:**
- *Line-ups:* quarterbacks and key injuries partial; inactives and coaches not demonstrated. Answer **No**.
- *Sources:* accurate.
- *Blind spot:* the missing margin table.
...
#### 2026-09-15 settlement and retrospective — P-413 (FINAL / SETTLED) — Rank #1 and Rank #2 lost

**Final:** Baltimore Ravens 41–23 Indianapolis Colts (Baltimore 31–13 at half-time; no overtime). **Source:** ESPN NFL event 401872659.
...
**Potential winner:** Baltimore 56% — **CORRECT**. **Card mean Brier:** 0.2984.

**Deep Rank-#1 retrospective:**

| Question | Finding |
|---|---|
| What went right | Winner; push mass at exactly 3 printed; new HC/OC/center held as width in words |
| What went wrong | Margin centre BAL +1.3 on a 56% winner; the Colts' prior used their first 10 games of 2025 with a healthy quarterback (57.6% scoring possessions) — a hand-picked window; Under 48.5 shared the same "controlled game" thesis |
| Actual mechanism | 31 first-half Baltimore points; 64 total |
| Knowable, and on the card? | Partly — "Lamar/Henry explosive separation" was named, but the Baltimore 14+ family carried only 12% |
| Improvement | `G-L12`; `L-011`/`G17` (a selected best window is a streak, not a prior); `G-L10` (Rank #1 and Rank #2 positively coupled); American football controls 17 and 19 |
| Grade | D+ |

**Validation questions:**
- *Line-ups:* depth charts and key inactives (Ravens full, Colts partial); coaching transition captured. Answer **Partial**.
- *Sources:* accurate.
- *Blind spots:* the centre shrink and the selected prior window.
...
#### 2026-09-15 settlement and retrospective — P-414 (FINAL / SETTLED) — Rank #1 and Rank #2 lost

**Final:** Buffalo Bills 36–31 Houston Texans (no overtime). **Source:** ESPN NFL event 401872660.
...
**Potential winner:** Buffalo 53% — **CORRECT**. **Card mean Brier:** 0.2917.

**Deep Rank-#1 retrospective:**

| Question | Finding |
|---|---|
| What went right | Winner; both inactive lists; the coaching transition |
| What went wrong | Houston's 2025 defensive baseline set both a margin compressor (centre BUF +0.7) and a total suppressor (centre 44.1) in Week 1 |
| Actual mechanism | Both offences scored freely (67 points); Buffalo by 5 |
| Knowable, and on the card? | Partly — "both QBs efficient" was named, but one defensive thesis set the direction of both top rows |
| Improvement | `G-L12` and `G-L2` (a prior-season unit rating is width in a new season); `G-L10` (print P(R1 ∧ R2)); American football control 19 |
| Grade | D+ |

**Validation questions:**
- *Line-ups:* depth charts and both inactive lists; coaching captured. Answer **Partial → nearly complete**.
- *Sources:* accurate.
- *Blind spot:* one thesis driving both top rows.
...
#### 2026-09-15 disposition — P-415

**ADMINISTRATIVE / NOT ISSUED.** No forecast existed, so nothing is graded and nothing is reconstructed. The ID is kept so the sequence stays auditable.
...
#### 2026-09-15 settlement and retrospective — P-416 (FINAL / SETTLED; PRIMARY_SCORED MLB)

**Final:** New York Yankees 2–0 New York Mets (8.5 innings; Schlittler 6.0 IP 0 R; Scott 6.0 IP 2 R). **Source:** MLB statsapi gamePk 823495. Both starters matched the card.
...
**Potential winner:** NY Yankees 63% — **CORRECT**. **Card mean Brier:** 0.2219.

**Retrospective:**
- *Driver:* Schlittler's six scoreless innings.
- *What went right, and why:* Under 8.0 and the winner; the wet-grounds delay was treated as a state, not information.
- *What went wrong:* Mets +1.5 lost by two — a two-run Yankees win was central on the card's own 1.4-run centre and 3.8-run width.
- *Smallest change:* print P(favourite by 2+) before ranking a +1.5 (baseball control 29).

**Validation questions:**
- *Line-ups:* posted orders from secondary game threads; starters official; bench and managers not captured. Answer **No**.
- *Sources:* accurate, but the lineup source was secondary.
- *Blind spot:* the run-line decomposition.
...
#### 2026-09-15 settlement and retrospective — P-417 (FINAL / SETTLED)

**Final:** Chunichi Dragons 6–0 Hanshin Tigers (9 innings; Muller complete-game shutout, 4 hits, 7 K; Itoh 5 IP 4 R; home runs Hosokawa and Muller). **Source:** NPB official box `s2026091401939`. The "probable" starters on the card were correct.
...
**Potential winner:** Hanshin 55% — **WRONG**. **Card mean Brier:** 0.2234.

**Retrospective:**
- *What went right, and why:* Dragons +1.5 — the card had recorded Muller's stronger profile (6.4 IP per start v 5.1).
- *What went wrong:* the winner label still chose the home side, and Under 5.5 lost at exactly 6 with every run by one team.
- *Knowable?* Yes, the starter asymmetry was printed.
- *Smallest change:* derive the winner label from the printed starter asymmetry, and give the one-team total branch mass (`G-L9`; the baseball kill path added with P-404).

**Validation questions:**
- *Line-ups:* starters probable (correct); orders and bench not recovered; managers not named. Answer **No**.
- *Sources:* accurate (SportsNavi's probable listing was fresher than the NPB indexed page).
- *Blind spot:* the home default on the winner label.
...
#### 2026-09-15 settlement attempt — P-418 (OPEN — IDENTITY/STATE CONFLICT; `TMP-OPEN-20260915-04`)

**Not settled; no W/L and no Brier.**
- The card itself recorded a fixture-time conflict (AiScore/Sofascore 12:00 UTC v TNT 13:00 UTC) and a stale Drukpa club schedule that omitted the fixture.
- At settlement, the **Bhutan Broadcasting Service** round report dated **2026-09-15** lists the concluding first-round results as Paro 5–1 Thimphu, Thimphu City 4–0 Tensung, Transport United 1–0 Ugyen Academy, **RTC 3–3 Tsirang** and **BFF Academy U-20 2–2 Drukpa**. It contains no Drukpa–RTC match.
- The **Bhutan Football Federation**'s search listing shows an RTC 1–1 Drukpa report, undated on the listing and most likely the earlier meeting.
- ESPN has no Bhutan route (`bhu.1` HTTP 400); Sofascore and AiScore returned HTTP 403.

**Retrospective:**
- *Blind spot:* the identity gate (`G0`) was treated as passed on aggregator listings that disagreed with each other, while the club's own schedule was stale.
- *Smallest change:* in sparse competitions, confirm the exact fixture with the federation or national broadcaster before issue, or fail closed (`RULES_GENERAL.md` §16.10(i)).

**Validation questions:**
- *Line-ups:* XI, goalkeeper and bench not retrieved; both coaches named (Dorji Khandu, Ugyen Dorji). Answer **No**.
- *Sources:* the fixture listings were unreliable; better sources are BBS and BFF.

**Retry trigger:** a dated BFF or BBS fixture list or report naming Drukpa's opponent for 13–15 September.
...
#### 2026-09-15 settlement and retrospective — P-419 (FINAL / PARTIAL)

**Final:** Djurgårdens IF 2–0 GAIS (35', 63'; corners 2–2). **Source:** ESPN `soccer/swe.1` event 401873992.
...
| 4 | Under 3.5 total goals | 0.70 | **WIN** | 0.0900 | 2 |
| 5 | Total corners Over 7.5 (self-generated alternate) | 0.69 | **PROVISIONAL LOSS — not booked** | — | ESPN 4; Allsvenskan record not reached — `TMP-OPEN-20260915-05` |

**Potential winner:** Djurgården 60% — **CORRECT**. **Card mean Brier (4 graded):** 0.0471.

**Retrospective:**
- *What went right, and why:* ranks 1–4 came from home chance creation against a weak GAIS attack. The unranked 1H Over 0.5 (62%) and Under 2.5 (51%) also won.
- *What went wrong:* a 69% self-generated corner alternate without a per-team corner table.
- *Smallest change:* self-generated derivatives need the same provider and exposure chain as supplied rows (soccer control 23).

**Validation questions:**
- *Line-ups:* not retrieved (the squad was due an hour before kick-off); coaches not named. Answer **No**.
- *Sources:* accurate.
- *Blind spot:* the ungrounded derivative alternate.
...
#### 2026-09-15 settlement and retrospective — P-420 (FINAL / SETTLED; PRIMARY_SCORED MLB) — Rank #1 lost

**Final:** Chicago Cubs 7–3 Atlanta Braves (López 3.0 IP 5 ER; Peterson 6.0 IP 1 ER). **Source:** MLB statsapi gamePk 824629. Starters matched the card.
...
**Potential winner:** Chicago Cubs 56% — **CORRECT**. **Card mean Brier:** 0.2729.

**Deep Rank-#1 retrospective:**

| Question | Finding |
|---|---|
| First decisive checkpoint | Top of the 3rd: López out after 3.0 IP, 5 ER |
| What went right | Over 9.5 and the winner; López's return ladder was retrieved (rehab five scoreless; return start 4.2 IP 6 ER) |
| What went wrong | Margin centre Cubs +0.3, despite "López return collapses" being the first kill path |
| Actual mechanism | Early hook, Cubs 5–0 after three; Peterson six innings, one run |
| Knowable, and on the card? | Yes — the 43% complement had to hold the hook, a power cluster and Atlanta relief exposure |
| Improvement | Baseball control 29(c) (early-hook mass for an IL-return starter; P(opponent by 2+) printed); control 25; `G-L9`; `G-L12` |
| Grade | C |

**Validation questions:**
- *Line-ups:* orders "pass with source limitation"; bench and managers not captured. Answer **No**.
- *Sources:* accurate.
- *Blind spot:* hook risk applied to width but not to the centre.
...
#### 2026-09-15 settlement and retrospective — P-421 (FINAL / SETTLED; PRIMARY_SCORED MLB) — top two both won

**Final:** New York Yankees 8–3 Minnesota Twins (Yankees six-run 8th; Warren 5.2 IP 0 ER; Kremer 5.2 IP 1 ER). **Source:** MLB statsapi gamePk 823656. Starters matched; the card rejected stale "Bailey Ober" previews.

| Rank | Contract | `p` | Result | Brier | Note |
|---:|---|---:|---|---:|---|
| 1 | New York Yankees −1.5 | 0.52 | **WIN** | 0.2304 | won by 5 |
| 2 | Over 8.0 (50 / 12 / 38) | 0.50 | **WIN** | 0.2500 | 11 |
| 3 | Minnesota Twins +1.5 | 0.48 | **LOSS** | 0.2304 | lost by 5 |
| 4 | Under 8.0 (38 / 12 / 50) | 0.38 | **LOSS** | 0.1444 | 11 |

**Potential winner:** NY Yankees 65% — **CORRECT**. **Card mean Brier:** 0.2138.

**Retrospective:**
- *What went right, and why:* official starter identity over stale previews, and the Twins' lineup deficit (Buxton out, Lewis limited) carried as −0.35 with a named mechanism.
- *Note:* the Over was decided by one late inning (baseball control 19). The favourite handicap won — part of the 7 W / 3 L favourite-handicap record.

**Validation questions:**
- *Line-ups:* order partial (the Caballero/Volpe conflict was preserved); managers not named. Answer **No**.
- *Sources:* accurate. *Blind spot:* none material.
...
#### 2026-09-15 settlement and retrospective — P-422 (FINAL / SETTLED) — Rank #1 lost

**Final:** Kansas City Chiefs 31–10 Denver Broncos (no overtime). **Source:** ESPN NFL event 401872931.
...
**Potential winner:** Kansas City 54% — **CORRECT**. **Card mean Brier:** 0.2672.

**Deep Rank-#1 retrospective:**

| Question | Finding |
|---|---|
| What went right | Under 42.5 and the winner; Mahomes' ACL return treated as a two-sided branch in words |
| What went wrong | Centre KC +1.0 on a 54% winner — the Mahomes uncertainty moved the centre toward Denver instead of only widening it; margin width ~10.5 against a published NFL residual SD of about 13.9 |
| Actual mechanism | Kansas City by 21 at home |
| Knowable, and on the card? | Partly — "Mahomes fully mobile" was the first kill path, but its mass was not separated from the one-score families |
| Improvement | `G-L12`; American football controls 17 and 18 (existing control 16 was cited but applied as a centre shrink) |
| Grade | D+ |

**Validation questions:**
- *Line-ups:* depth charts; Denver inactives printed; KC partial; KC head coach not printed. Answer **Partial**.
- *Sources:* accurate.
- *Blind spot:* the centre shrink.
...
#### 2026-09-15 settlement and retrospective — P-423 (FINAL / SETTLED; PRIMARY_SCORED MLB) — Rank #1 lost by one run

**Final:** San Diego Padres 8–7 Colorado Rockies (Mize 5.0 IP 2 ER; Sugano 5.0 IP 6 ER). **Source:** MLB statsapi gamePk 824308. Starters matched the card.
...
**Potential winner:** San Diego 66% — **CORRECT**. **Card mean Brier:** 0.2575.

**Deep Rank-#1 retrospective:**
- *Checkpoint:* the bottom 9th, with Colorado within one.
- *What went right:* the Over, Rockies +1.5 and the winner; Mize's identity was confirmed over stale TBD pages.
- *What went wrong:* a road −1.5 at Coors, where the home side bats last; the exactly-one-run Padres-win mass (≈12%) was implied but not printed.
- *Knowable?* Yes — "Colorado home-last-bat rally" was a named kill path.
- *Improvement:* baseball control 29(b). Grade B− (boundary).

**Validation questions:**
- *Line-ups:* Colorado order corroborated, San Diego partial; managers not named. Answer **No**.
- *Sources:* accurate.
- *Blind spot:* the unprinted one-run mass.
...
|---|---|---|---|
| `TMP-OPEN-20260911-03` | `P-364` potential winner | England to win the 3rd Test | **RETIRED 2026-09-15 — WIN** (England won by 8 wickets, 12 Sep; ESPNcricinfo scorecard). *(Was: live at last Drive retrieval.)* |
...
**2026-09-15 settlement.** Each event's settlement table and retrospective is written directly under its card above.

| ID | Final | Rank #1 | Rank #2 | Potential winner | Card mean Brier | Status |
|---|---|---|---|---|---:|---|
| P-407 | Club Brugge 3–1 Antwerp | provisional W (corners) | W | W | 0.2005 (4) | PARTIAL — `TMP-OPEN-20260915-01` |
| P-408 | Brighton 5–0 away | **L** | W | W | 0.2027 | SETTLED |
| P-409 | Lille 2–0 Troyes | W | provisional W (corners) | W | 0.0756 (4) | PARTIAL — `TMP-OPEN-20260915-02` |
| P-410 | RB Leipzig 5–0 HSV | W | W | W | 0.0310 (4) | PARTIAL — `TMP-OPEN-20260915-03` |
| P-411 | Spain 81–58 Germany | **L** | W | W | 0.2672 | SETTLED |
| P-412 | Steelers 20–13 Falcons | **L** | W | W | 0.2617 | SETTLED |
| P-413 | Ravens 41–23 Colts | **L** | L | W | 0.2984 | SETTLED |
| P-414 | Bills 36–31 Texans | **L** | L | W | 0.2917 | SETTLED |
| P-415 | — | — | — | — | — | NOT ISSUED |
| P-416 | Yankees 2–0 Mets | W | L | W | 0.2219 | SETTLED |
| P-417 | Chunichi 6–0 Hanshin | W | L | L | 0.2234 | SETTLED |
| P-418 | not verified as played | — | — | — | — | OPEN — identity conflict `TMP-OPEN-20260915-04` |
| P-419 | Djurgården 2–0 GAIS | W | W | W | 0.0471 (4) | PARTIAL — `TMP-OPEN-20260915-05` |
| P-420 | Cubs 7–3 Braves | **L** | W | W | 0.2729 | SETTLED |
| P-421 | Yankees 8–3 Twins | W | W | W | 0.2138 | SETTLED |
| P-422 | Chiefs 31–10 Broncos | **L** | W | W | 0.2672 | SETTLED |
| P-423 | Padres 8–7 Rockies | **L** | W | W | 0.2575 | SETTLED |

**Totals:** 61 graded rows, 39 W / 22 L, mean Brier 0.2088. Rank #1 6 W / 8 L (+1 provisional); Rank #2 10 W / 4 L (+1 provisional); top two both won 3 / 13; potential winners 14 / 15; preferred scoring over/under 12 / 15. Learning-only.
...
This mini log was settled, retrospected and imported into `PREDICTION_LOG_COMBINED_3.md` §"2026-09-15(b)" on 2026-09-15, and this updated copy is archived. The raw upload is kept byte-exact in `archive/mini_logs/originals_2026-09-15/` (218,707 bytes, SHA-256 `404903fc…7bbc`). Learning-only / not performance-eligible.

## Live-state check

At settlement every issued event had finished. **No event is live**, so nothing is carried forward as live. P-418 is open for an identity reason, not a live one.

## Temporary IDs (logs that needed a handle)

| Handle | Row | State | Retry trigger |
|---|---|---|---|
| `TMP-OPEN-20260915-01` | P-407-C01 Brugge corners Over 4.5 | PROVISIONAL WIN (ESPN 9) | Pro League match-centre record |
| `TMP-OPEN-20260915-02` | P-409-C02 Troyes corners Over 2.5 | PROVISIONAL WIN (ESPN 5) | LFP / Ligue 1 match-centre record |
| `TMP-OPEN-20260915-03` | P-410-C05 Leipzig corners Over 4.5 | PROVISIONAL WIN (ESPN 8) | bundesliga.com match facts |
| `TMP-OPEN-20260915-04` | **P-418 whole card** | IDENTITY/STATE CONFLICT | Dated BFF/BBS fixture or report naming Drukpa's 13–15 Sep opponent |
| `TMP-OPEN-20260915-05` | P-419-C05 corners Over 7.5 | PROVISIONAL LOSS (ESPN 4) | Allsvenskan record |

No ID collision needed a `TMP-SETTLED` handle. The working IDs P-407–P-423 are canonical as issued; P-372 is RESERVED / UNUSED; the next canonical ID is **P-424**.

## Why the picks went right or wrong (cross-card), linked to earlier lessons

1. **The underdog-cushion shortfall.**
   - Six of the eight Rank-#1 losses were underdog cushions or a boundary cushion (P-411, P-412, P-413, P-414, P-420, P-422).
   - Across `P-345`–`P-423`, Rank-#1 underdog cushions went **10 W / 13 L** at a mean stated 0.61, while Rank-#1 favourite handicaps went **7 W / 3 L** at 0.57.
   - The printed margin centres in this log missed toward the favourite on 8 of 10 cards (mean +6.1), and the NFL margin width (~10.5) was narrower than the published residual SD (≈13.9, Stern 1991).
   - This is `G-L2`'s failure mirrored onto the margin — uncertainty turned into a signed lean toward the underdog — and it recurs from P-373, P-383, P-391, P-396 and P-403.
2. **Named kill paths without mass** (`G-L9`, recurring since `P-347`): P-408, P-411, P-420 and P-423 all printed the mechanism that beat them.
3. **One thesis, two rows** (`G-L10`, recurring since `P-364`): P-413 and P-414 lost both top rows to the same favourite blow-out.
4. **Corners are not goals** (soccer controls 4 and 21, recurring P-399 and P-402): P-408 had Brighton win 5–0 with 3 corners.
5. **What went right:** winner identification 14 / 15; goal-based soccer rows 19 W / 1 L built on current xG and shots on target (the P-346 pattern); official starter identity over stale previews (P-421, P-423); honest uncertainty on P-409/P-410.

## Answers to the three validation questions (log roll-up)

- **Line-ups, bench and coaches:** complete for both sides on 0 of 16 issued cards (P-414 nearly). Soccer XIs are usually published before the 2–8-minute freezes used here, but publication time was not proven (`PUBLICATION_TIME_UNVERIFIED`). No Rank-#1 loss turned on a missing name.
- **Source accuracy:** accurate on every fact checked, except P-418's fixture listings. Secondary lineup threads (P-416) and lower-tier predicted-lineup pages (P-407) were weak but disclosed.
- **Blind spots and the fix:** the margin-centre shrink, missing margin tables and key numbers, the ungrounded self-generated corner alternate, and fixture identity in a sparse league. Fixes are listed below.

## Over/under research (the standing directive)

- The preferred scoring over/under won 12 of 15 in this log (Over-preferred 7 / 7, Under-preferred 5 / 8). Across the whole import it was 32 / 48, with Overs 20 / 27 — but Overs were 1 / 5 in `P-345`–`P-371`. **No stable directional edge; no Over or Under preference is adopted.**
- What raised the chance that at least one preferred over/under won: large-edge team-goal and first-half rows (11 / 11 here) and not letting a single thesis set two over/under rows.
- Adopted as disclosure: print P(at least one preferred over/under wins) = pA + pB − P(A ∧ B) whenever two top rows share a driver; print exact integer masses; keep `C-PHASE-VS-FULL-TOTAL` under test (soccer 1H Over 0.5 when preferred: 7 of 9 across the import).

## General learnings and rule changes — implemented, with destinations

| Change | Where |
|---|---|
| **`G-L12`** margin prior with source; uncertainty widens, never centres toward pick'em; width floor; P(favourite by more than the line) and key-number masses | `RULES_GENERAL.md` §16.10(h) |
| Fixture identity confirmed at federation or national broadcaster in sparse competitions (P-418) | `RULES_GENERAL.md` §16.10(i); `RULES_SOCCER.md` §"2026-09-15(b)" |
| Derivative settlement at the competition's official data record; data-partner displays provisional unless pre-registered (P-408) | `RULES_GENERAL.md` §16.10(j); `RULES_SOCCER.md` control 32 |
| American football controls 17–19 (margin prior + width floor; key numbers 3/7; prior-season unit ratings are width) | `RULES_AMERICAN_FOOTBALL.md` |
| Baseball control 29 (P(favourite by 2+); home-last-bat one-run mass; IL-return hook mass) | `RULES_BASEBALL.md` |
| Basketball control 25 (same-competition meeting is current evidence) | `RULES_BASKETBALL.md` |
| Soccer control 33 (corner generators; leading-state branch) | `RULES_SOCCER.md` |
| `G-L12` instantiation in cricket, NRL, AFL, tennis, ice hockey and rugby union | respective sport files §"2026-09-15(b)" |
| `C-MARGIN-TAIL-MASS` (supersedes `C-UNDERDOG-SEPARATION`); `C-PROB-EXTREMITY` and `C-RUN-CENTRE-BIAS` not supported by this cohort; 25-card `PRIMARY_SCORED` review | `LEARNING_REGISTER.md` §"2026-09-15(b)"; `CONTROLS.md`; `METHOD.md` |

## Observations

- `PRIMARY_SCORED` reached **25 cards** with this import; running 104 rows, mean Brier 0.2522 (MLB 0.2473, EPL 0.2267, NRL/AFL 0.3053) — not better than a coin flip.
- Rows stated at ≥ 0.70 won 19 of 21 across the import; Rank-#1 rows stated 0.50–0.60 won 10 of 22.
- Log-C MLB total residuals averaged +0.3 runs (n = 4).

## New and re-graded sources

| Source | Grade | Use |
|---|---|---|
| **Premier League official data API** (`footballapi.pulselive.com`; `Origin`/`Referer` headers; integer `compSeasons` 841) | `CANDIDATE — FIELD OWNER` | EPL corners, shots, finals (settled P-408 and P-402) |
| ESPN site API soccer summaries (bel.1, fra.1, ger.1, swe.1 verified here) | `CANDIDATE` | Corroboration; provisional where not pre-registered |
| MLB statsapi `game/<pk>/boxscore` | field owner | Starter IP/ER |
| NPB English box pages; FIBA game pages | field owner | P-417; P-411 |
| BBS (Bhutan Broadcasting Service) round reports; Bhutan Football Federation reports | `RESEARCH` / `CANDIDATE` | Sparse-league fixture identity (P-418) |
| Web-search summaries | **Excluded** | Wrong numbers seen twice (a Test chase score; a FIBA top-scorer total) |

Registered in `SOURCES.md` and `DATA_SOURCE_REGISTER.md` §"2026-09-15".
