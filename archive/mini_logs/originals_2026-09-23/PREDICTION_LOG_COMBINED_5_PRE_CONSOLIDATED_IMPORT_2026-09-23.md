...
Next canonical ID: **P-495** (updated 2026-09-23 after supplemental WTA live-view reconciliation; fresh preflight remains required before any new forecast).
...
| Field | Current value |
|---|---|
| As of | **2026-09-23, Australia/Sydney** — P-482–P-483 retained from the prior settled import; P-484–P-494 custody reconciled; P-494 is a live WTA view, with no terminal-state refresh or retrospective performed |
| Highest canonical prediction ID | **P-494** |
| Next canonical ID | **P-495** |
| Part-5 issued events | **11 canonical event cards** — P-482, P-483, P-484, P-485, P-486, P-488, P-489, P-491, P-492, P-493, P-494. P-487 is a noncanonical issue-time hold; P-490 is retired/unused. |
| Part-5 open / pending events | **4** — P-489 (Chunichi–DeNA), P-491 (Orix–Lotte), P-493 (KIA–Doosan), P-494 (live WTA view; terminal state not refreshed). P-494 is excluded from pregame metrics. |
...
| Active mini log | Mini logs (to be sent to actual log later)/Mini Prediction Log - P-494 onward - 2026-09-23/PREDICTION_MINI_RUNNING_LOG_P494_ONWARD.md — new local continuation; P-482–P-493 predecessor retained for history and source provenance |
