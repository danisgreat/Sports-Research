...
**Predecessor status:** CLOSED TO NEW FORECASTS AFTER P-493. The active local mini log for new cards is PREDICTION_MINI_RUNNING_LOG_P494_ONWARD.md; unresolved carryovers are copied into that file.
**Last updated:** 2026-09-23 20:44:23 +10:00 - local log handoff; P-489, P-491, P-493 and TMP-20260923-NBL-CNS-TAS carried to the P-494-onward mini log. No results or retrospectives refreshed.
**Source preservation:** Byte-exact pre-reconciliation copies are in archive/mini_logs/originals_2026-09-23/; the two temporary working files now contain receipts. No Google Drive files were modified.

| # | Source mini log | Original local folder | Entries it held |
|---|---|---|---|
...
| 2 | PREDICTION_MINI_RUNNING_LOG_P484_ONWARD.md | source variant | Padres/WNBA P-484 collision, P-485/P-486/P-488/P-489/P-491 cards, recovered P-487 NBL card and KBO card; P-489 R1. Full unique material consolidated below. |
| 3 | PREDICTION_MINI_RUNNING_LOG_P484_ONWARD_SETTLED_2026-09-23.md | source variant | Prior reconciliation assigned Padres P-490 provisionally; superseded by current P-492 canonical mapping. |
| 4 | PREDICTION_MINI_RUNNING_LOG_P490_ONWARD.md (historical local template) | source variant | Template only; no forecast entry. P-490 is retired as an unused slot after current P-492 assignment. |
...
**Canonical authority:** PREDICTION_LOG_COMBINED_5.md has highest canonical ID P-493 and next ID P-494. This predecessor preserves P-482-P-493 source cards and handoff evidence; new forecasts belong in the P-494-onward mini log after fresh preflight.
...
|---|---|---|---|---|
| **P-482** | Cricket — CPL 2026 Final, Antigua & Barbuda Falcons vs Jamaica Kingsmen | #1 | SETTLED | Clean (08:54:41 AEST < 09:00 start) |
| **P-483** | Tennis — WTA Seoul R32, Volynets vs Kalieva | #1 | SETTLED | START_CROSSED by 42 s |
| **P-484** | WNBA — Atlanta Dream @ New York Liberty | #2/#3 | SETTLED | Card-stated near-tip; unverified |
| **P-485** | NFL — NY Giants @ LA Rams | #2/#3 | SETTLED | START_CROSSED; pregame status unverified |
| **P-486** | MLB — Minnesota Twins @ San Francisco Giants | #2/#3 | SETTLED | Clean per card |
| **P-487** | RESERVED / ISSUE-TIME HOLD — NBL source claims this slot | TMP-20260923-NBL-CNS-TAS | NONCANONICAL HOLD | Original freeze time absent; do not reuse pending sequence review |
| **P-488** | WTA Singapore — Wolff vs Oliynykova | #2/#3 | SETTLED | Card-stated pre-match |
| **P-489** | NPB — Chunichi Dragons @ Yokohama DeNA | #2/#3 | UNSETTLED | Issue horizon unverified; same-event R1 appended |
| **P-490** | RESERVED / RETIRED PROVISIONAL PADRES ALIAS | Earlier mini-log alias only | UNUSED / NOT A CARD | Do not reuse |
| **P-491** | NPB — Orix Buffaloes @ Chiba Lotte Marines | this file | UNSETTLED | CLEAN pre-start freeze around 17:54 AEST; terminal state not checked |
| **P-492** | MLB — SD Padres @ LA Dodgers | #2/#3 | SETTLED | START_CROSSED; source claim P-484 and former provisional P-490 are aliases |
| **P-493** | KBO — Kia Tigers @ Doosan Bears | recovered #4 card | UNSETTLED | Pre-start freeze 19:28:29 AEST; terminal state not checked |

**At handoff:** next canonical ID is P-494. This predecessor is closed to new forecasts. P-491 is Orix @ Lotte; P-492 is Padres @ Dodgers; P-493 is KIA @ Doosan.

## ID collision resolution and current canonical crosswalk — 2026-09-23

The repeated P-484 is a two-event collision: Atlanta Dream @ New York Liberty (WNBA) and San Diego Padres @ Los Angeles Dodgers (MLB). The WNBA card retains P-484. Its event was scheduled for 22 Sep 2026, 10:00 AEST and the preserved card reports a near-tip pregame refresh with the official event still upcoming. The Padres card was a later event, scheduled 23 Sep 2026, 12:10 AEST; its own preserved final check was 12:13 AEST, after the scheduled start. This supports keeping the earlier WNBA P-484 issue. The Padres card receives P-492, the next available canonical number after P-491, as specifically requested. Its former P-484 source claim and prior provisional P-490 mini-log number remain aliases only. P-490 is retired as an unused slot and will not be reused.

| Event | Earlier/source label | Current custody |
|---|---|---|
| Atlanta Dream @ New York Liberty (WNBA) | P-484 | Canonical P-484 retained |
| New York Giants @ Los Angeles Rams (NFL) | P-485 | Canonical P-485 retained |
| Minnesota Twins @ San Francisco Giants (MLB) | P-486 | Canonical P-486 retained |
| Cairns Taipans vs Tasmania JackJumpers (NBL) | P-487 claim in the later temporary file | TMP-20260923-NBL-CNS-TAS; P-487 is held as a reserved slot, not assigned to a canonical card, until an original issue/freeze timestamp verifies sequence. The earlier no-card gap finding is superseded as to card existence. |
| Vivian Wolff vs Oleksandra Oliynykova (WTA Singapore) | P-488 | Canonical P-488 retained |
| Chunichi Dragons @ Yokohama DeNA BayStars (NPB) | P-489; R1 uses the same event | Canonical P-489; R1 is append-only and consumes no second ID |
| P-490 | Prior provisional Padres mapping | RETIRED / RESERVED UNUSED; do not reuse |
| Orix Buffaloes @ Chiba Lotte Marines (NPB) | P-491 | Canonical P-491 retained |
| San Diego Padres @ Los Angeles Dodgers (MLB) | P-484 source claim; prior mini-log P-490 | Canonical P-492; one event, one record |
| Kia Tigers @ Doosan Bears (KBO) | No prior ID | Canonical P-493; frozen 19:28:29 AEST, before its 19:30 AEST scheduled start |

The NBL card is preserved in the active log under its stable TMP handle because its original issue timestamp is absent and the latest available status addendum says the official site showed LIVE NOW at 19:34:50 AEST. No later score/result check or retrospective was done. The raw response that had incomplete player data and exposed a bookmaker object remains quarantined exactly as described in the source card.

Same-event Orix and Chunichi records were not duplicated. The 18:59:17 AEST Chunichi R1 is appended under P-489 without overwriting the earlier card. The request for Vukic vs Jacquet has no issued local card in the supplied log files and receives no ID.

All P-482–P-493 material remains LEARNING_ONLY / NOT PERFORMANCE_ELIGIBLE. No Drive write, new forecast, result review, or retrospective was performed in this reconciliation.
...
- **Outstanding reconciliation items**, carried to canonical import:
  1. **REVIEW-P487-ISSUE-TIME:** NBL source claims P-487 but its original freeze time is missing. Keep the TMP handle and P-487 reserved until a timestamp establishes canonical sequence.
  2. **REVIEW-PART5-SNAPSHOT:** Part 5 still lists P-482 as next.
     ...
     - P-484–P-493 in this log sit above them.
  ...
  3. **REVIEW-HORIZON:** Several cards stay learning-only whatever their canonical number:
     - P-483 (WTA Seoul), P-485 (NFL) and P-492 (Padres) are START_CROSSED / PREGAME STATUS UNVERIFIED.
...
6. **Source-log retirement:** use byte-exact snapshots in archive/mini_logs/originals_2026-09-23/ for the two cleared temporary logs and prior merged log; do not append to temporary receipts or this predecessor.
...
- **Shared driver, disclosed by the card.** The #1 Over and #2 Kalieva +4.5 shared one driver, Kalieva staying competitive. Unlike P-492, the card **did** disclose the coupling:
...
## Merged-log descriptive totals (7 settled cards: P-482–P-486, P-488, P-492; not performance evidence)
...
| Hit@2 | 5 / 7 (P-483 and P-492 missed) |
| Both top two won | 0 / 7. In P-482 the top two were a forced pair, so both could not win. |
| Projected winner | 6 / 7 (P-486 wrong) |
| Preferred total/phase direction | 4 W / 3 L. Unders 3–1; Overs 1–2 (P-482 won; P-483 and P-492 lost) |
| TOP_OU_REVIEW triggered | P-483, P-484, P-492 |
| Horizon problems | P-483, P-485, P-492 (START_CROSSED) plus P-489 (unverified): 4 of 8 cards |
| Top two sharing one driver, both lost | P-483 (Kalieva competitiveness), P-492 (King early suppression) |
...
- **Cross-sport (strengthened): correlated top two.** Two cards, in two sports, lost both top picks to a single shared driver.
  - P-492 did not disclose the coupling.
...
## Earlier 5-card analysis (P-484–P-492 revision; retained)

Scope: five settled cards (P-484, P-485, P-486, P-488, P-492) across four sports and five leagues. Everything below is descriptive and learning-only.
...
| Hit@2 | 4 / 5 cards (P-492 missed) |
| Both top two won | 0 / 5 |
| Projected winner | 4 / 5 correct (P-486 wrong) |
| Preferred game-total direction | 3 W / 2 L. Unders 3–1 (P-485, P-486, P-488 won; P-484 lost); the only preferred Over (P-492) lost. |
| TOP_OU_REVIEW triggered | P-484, P-492 |
| Issue-horizon problems | P-485, P-492, plus unsettled P-489 |
...
1. **Issue-horizon discipline is the most frequent process defect in this log.**
   - Three of six cards have start-crossing or horizon conflicts: P-485, P-492 and P-489.
...
2. **Named kill paths without mass recur across sports.**
   ...
   - P-492: "Padres lose by 2+ very real", then +1.5 ranked #2.
...
4. **Top-two rows sharing a single driver.** P-492's #1 and #2 both depended on King's early suppression and failed together. Print P(R1 ∧ R2) with a coupling label (G-L10) and state it in the card.
5. **Opponent-unadjusted short recency windows.** P-492 (King's L5; the Padres' L5/L10 against Colorado and Miami) is a recurrence of the R-1 finding and the README's P-453 reclassification.
...
- **Baseball (MLB), 2 cards.**
  ...
  - A bullpen game is not directional. P-492's card said so, correctly, for the side market but not for the total.
...
|---|---|---|
| **PR-1 Hard pre-start freeze.** A card's final volatile refresh and freeze timestamp must precede the verified scheduled start. If the freeze time is at or after scheduled start, the card is labelled START_CROSSED at issue, not only at settlement, and the mini log records it that way from creation. | 3 of 6 cards in this log (P-485, P-492, P-489). The rule text already exists; this is an operational enforcement checklist item. | **Strong candidate.** Recurring, process-only, no predictive weight. |
...
| **PR-3 Shared-driver disclosure for the top two.** Print the single dominant driver of R1 and R2 and the coupling label (G-L10). | P-492 | Candidate. Reinforces an existing gate. |
...
- **MLB first-five vs relief-state separation (candidate).** Evidence: P-486, P-492.
...
| Baseball Savant player pages | xERA/xwOBA | **Always pin `season=2026` in the URL.** P-492's cited link carried `season=2023`, making the xERA attribution unverifiable. |
...
- Missing official lineups at issue: P-484 (both), P-486 (SF), P-492 (both officially).
- Missing bench/relief ladders and injury lists for one side: P-484, P-486, P-492.
- Starter/opponent-specific history not retrieved: P-492.
- Freeze after start: P-485, P-492, P-489.
...
No forecast content was modified in this handoff. The two temporary source logs were replaced by receipts after byte-exact archive verification. This file is the predecessor through P-493; new forecasts continue in the P-494-onward local mini log.
...
| P-484 collision and P-487/P-490 custody resolution; P-492 Padres and P-493 KBO; next P-494 | PREDICTION_LOG_COMBINED_5.md; GAME_LOG_STATUS_CURRENT.md |
...
| Named kill path without mass (P-484, P-486, P-492) | `LEARNING_REGISTER.md` (recurrence under L-075 / G-L9); `RULES_GENERAL.md` §16.5 note |
...
7. **P-492** — MLB — SD Padres @ LA Dodgers (claimed P-484; moved to next number) — LAD 7–0 — settled; START_CROSSED
...
## Logs still awaiting settlement (current ID-only status; no retrospective)

- **P-489** — Chunichi Dragons @ Yokohama DeNA BayStars — scheduled start passed; current terminal state not checked; issue horizon unverified; original card and same-event R1 retained.
- **P-491** — Orix Buffaloes @ Chiba Lotte Marines — pregame freeze retained; scheduled start passed; terminal state not checked.
- **P-493** — Kia Tigers @ Doosan Bears — pre-start freeze recorded 19:28:29 AEST; scheduled 19:30; terminal state not checked.
- **TMP-20260923-NBL-CNS-TAS** — Cairns vs Tasmania — original issue time/sequence unresolved; later live-state note is quarantined; no settlement or retrospective.

P-487 is reserved on issue-time hold; P-490 is retired/unused. **NEXT ID: P-494.**
...
The full brief (dated 2026-09-21) is preserved in the byte-exact archive copy archive/mini_logs/originals_2026-09-23/PREDICTION_MINI_RUNNING_LOG_P482_ONWARD_PRE_RECON_2026-09-23.md, under "User-Supplied Mini-Log and Settlement Instructions - 2026-09-21".

# 2026-09-23 reconciliation addenda — recovered temporary-source material

These cards were copied from the byte-exact archived source mini log. They are preserved as issued/source text; the ID mappings above supersede only the temporary-ID custody statements. No retrospective or result update is included here.

### P-489 append-only same-event reforecast R1 (source card follows verbatim)
...
### P-493 KBO card (source card follows verbatim; canonical mapping appended)
### TMP-20260923-KBO-KIA-DOO — Kia Tigers @ Doosan Bears (pregame forecast; canonical ID unresolved)
...
**ID custody.** The local Part 5 snapshot says P-484 is next, but the active mini log records an existing Padres P-484 claim, a conflicting WNBA P-484 claim, and additional unregistered P-485/P-486/P-488/P-489 claims. The latest Drive Part 5 copy says P-482 is next and conflicts with the local P-482/P-483 registration. Do not assign a canonical ID until these records are reconciled. This event is held as `TMP-20260923-KBO-KIA-DOO`; next canonical ID remains frozen.
...
**Method / document mapping.** Applied local `METHOD.md` MDS-2026.09.19-v4.3 and `RULES_BASEBALL.md` SFA-BASEBALL / KBO §9.4; market blind, no bookmaker or fantasy sources. `CONTROL_MANIFEST_2026-09-21-3.md` receipt has the METHOD, baseball-rule and scoring-file hashes. Update eventual home: `PREDICTION_LOG_COMBINED_5.md` (after ID reconciliation), `GAME_LOG_STATUS_CURRENT.md`, `RULES_BASEBALL.md` only if later evidence justifies a reusable KBO source/availability rule; otherwise retain lineup and scoring observations in this mini log. No retrospective requested or performed.
...
ID custody: the exact fixture already has the temporary handle `TMP-20260923-NBL-CNS-TAS` and a pregame card is preserved above. Do not create a duplicate event row or issue another pick set. The canonical queue remains frozen by the P-484/P-487 claims and Part 5/mini-log mismatch; no canonical ID is assigned by this update. Preserve the earlier card as issued; this addendum does not settle, grade, or retrospect it.
...
## Reconciled current status — 2026-09-23 20:02 AEST

| Custody | Event | Current state |
|---|---|---|
| P-489 | Chunichi Dragons @ Yokohama DeNA BayStars | Original card plus R1 retained; scheduled start has passed; current terminal state not checked; issue horizon remains unverified; no grade/retrospective. |
| P-491 | Orix Buffaloes @ Chiba Lotte Marines | Pregame freeze retained; scheduled start has passed; terminal state not checked; no grade/retrospective. |
| P-492 | San Diego Padres @ Los Angeles Dodgers | Final/settled and retrospective already present from the earlier mini-log; original P-484 and provisional P-490 preserved as aliases. |
| P-493 | Kia Tigers @ Doosan Bears | Freeze was pre-start at 19:28:29 AEST; scheduled 19:30; current terminal state not checked; no grade/retrospective. |
| TMP-20260923-NBL-CNS-TAS | Cairns Taipans vs Tasmania JackJumpers | Original forecast retained; P-487 claim held pending verifiable issue-time/sequence; later in-progress status was not validated; no settlement or retrospective. |

P-487 remains an issue-time hold and P-490 remains reserved/unused. NEXT CANONICAL ID: P-494. All cards remain LEARNING_ONLY / NOT PERFORMANCE_ELIGIBLE.
