...
`SPORTS_ACTIVE_ANALYSIS_MODELS_v1.md` specifies the separately authorized qualitative tier. Its deterministic leans are not predictions eligible for calibration or profitability reporting and are not written into the prediction journal.
