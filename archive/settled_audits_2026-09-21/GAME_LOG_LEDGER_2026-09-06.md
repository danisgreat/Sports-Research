# Complete game-log ledger — every entry from `P-001`, 2026-09-06

**Current status — 2026-09-06(f):** 318 canonical records through P-317 plus LOCAL-GEELONG-20260904; 295 settled, 8 partial, 4 research-settled, 8 administrative, 1 identity conflict, 1 terminal corner closure, 1 superseded alias. **Nine result-evidence follow-ups and four special operator-only follow-ups.** [Complete per-game retrospective and current queue](archive/mini_logs/PREDICTION_MINI_LOG_SETTLEMENT_2026-09-06.md). Older dated counts below are historical. P-318 is next.

Generated from `GAME_LOG_STATUS_INDEX_2026-09-05.md` (as updated by the 2026-09-06 settlement pass), which remains the canonical row-by-row record. One line per canonical record, in ID order, from the first entry in the log.

| Status | Count |
|---|---:|
| `FINAL / SETTLED` — fully graded | 285 |
| `FINAL / PARTIAL` — main rows graded, one sub-row open | 9 |
| `FINAL / RESEARCH SETTLED` — result known, contract-terms question open | 3 |
| `UNRESOLVED` — identity/state conflict | 1 |
| `FINAL / CLOSED` — one row terminally unsettleable | 1 |
| `FINAL / CLOSED` — nothing issued to grade | 7 |
| **Awaiting a result** | **0** |

**Historical pre-P-306 snapshot: 306 records.** Current 318-record totals and unresolved evidence are in the banner and dated addendum; P-126 remains an identity/state conflict.

## Historical follow-up list — current disposition is in the dated addendum

| Temp ID | Canonical | Event | Open item |
|---|---|---|---|
| `T-001` | `P-126` | Sikkim Aakraman FC vs Sikkim Boys Club — SFA A Division S-League | UNRESOLVED — event identity/state, score/phase conflict and C06 corners |
| `T-002` | `P-148` | Toluca Femenil v León Femenil | FINAL / PARTIAL — C02 corners PROVISIONAL LOSS |
| `T-003` | `P-149` | Colorado Rapids 2 v Ventura County | FINAL / PARTIAL — C02 corners PROVISIONAL WIN |
| `T-004` | `P-166` | Melbourne Mustangs vs Canberra Brave — AIHL Goodall Cup Semifinal | FINAL / RESEARCH SETTLED — operator OT/action unresolved |
| `T-005` | `P-176` | Amiens SC vs FC Versailles — France Ligue 3 | FINAL / PARTIAL — C05 corners PROVISIONAL WIN |
| `T-006` | `P-178` | AS Cannes vs Le Puy-en-Velay — France Ligue 3 | FINAL / PARTIAL — C05 corners UNRESOLVED |
| `T-007` | `P-179` | Thionville Lusitanos vs Paris 13 Atletico — France Ligue 3 | FINAL / PARTIAL — C05 corners PROVISIONAL WIN |
| `T-008` | `P-200` | Herning Blue Fox vs Rungsted Seier Capital — Danish Metal Ligaen | FINAL / RESEARCH SETTLED — operator OT/action unresolved |
| `T-009` | `P-217` | Trinbago Knight Riders vs Guyana Amazon Warriors — Caribbean Premier League 2026 | FINAL / PARTIAL — C01/C02 reduced-overs action UNRESOLVED |
| `T-010` | `P-233` | Beijing Guoan vs Lanzhou Longyuan Athletic — China FA Cup 2026 | FINAL / PARTIAL — score/half rows SETTLED; C05 corners PROVISIONAL WIN |
| `T-011` | `P-234` | Dalian Yingbo vs Shanghai Shenhua — China FA Cup 2026 | FINAL / PARTIAL — score/half rows SETTLED; C03 corners PROVISIONAL WIN |
| `T-012` | `P-235` | Shandong Taishan vs Shanghai Port — China FA Cup 2026 | FINAL / PARTIAL — score/half rows SETTLED; C05 corners PROVISIONAL WIN |
| `T-013` | `P-274` | San Francisco Giants @ Pittsburgh Pirates | FINAL / RESEARCH SETTLED — listed-pitcher action conditional |

Also outside the graded count, with nothing issued to grade: `P-021`, `P-157`, `P-192`, `P-246`, `P-249`, `P-269`, `P-272` (administrative closures) and `P-003` (one corners row terminally unsettleable).

## Full list in ID order
...
| `P-126` `[T-001]` | Sikkim Aakraman FC vs Sikkim Boys Club — SFA A Division S-League | UNRESOLVED — event identity/state, score/phase conflict and C06 corners |
...
| `P-148` `[T-002]` | Toluca Femenil v León Femenil | FINAL / PARTIAL — C02 corners PROVISIONAL LOSS |
| `P-149` `[T-003]` | Colorado Rapids 2 v Ventura County | FINAL / PARTIAL — C02 corners PROVISIONAL WIN |
| `P-150` | Montreal @ Winnipeg, CFL | FINAL / SETTLED |
| `P-151` | Boca Juniors v Lanús | FINAL / SETTLED — Boca 1-0 Lanús (90+3'); Boca 11 corners, Lanús 3; Boca Over 4.5 corners WIN |
...
| `P-166` `[T-004]` | Melbourne Mustangs vs Canberra Brave — AIHL Goodall Cup Semifinal | FINAL / RESEARCH SETTLED — operator OT/action unresolved |
...
| `P-176` `[T-005]` | Amiens SC vs FC Versailles — France Ligue 3 | FINAL / PARTIAL — C05 corners PROVISIONAL WIN |
| `P-177` | SC Aubagne Air Bel vs Bourg-en-Bresse Péronnas — France Ligue 3 | FINAL / SETTLED |
| `P-178` `[T-006]` | AS Cannes vs Le Puy-en-Velay — France Ligue 3 | FINAL / PARTIAL — C05 corners UNRESOLVED |
| `P-179` `[T-007]` | Thionville Lusitanos vs Paris 13 Atletico — France Ligue 3 | FINAL / PARTIAL — C05 corners PROVISIONAL WIN |
...
| `P-200` `[T-008]` | Herning Blue Fox vs Rungsted Seier Capital — Danish Metal Ligaen | FINAL / RESEARCH SETTLED — operator OT/action unresolved |
...
| `P-217` `[T-009]` | Trinbago Knight Riders vs Guyana Amazon Warriors — Caribbean Premier League 2026 | FINAL / PARTIAL — C01/C02 reduced-overs action UNRESOLVED |
...
| `P-233` `[T-010]` | Beijing Guoan vs Lanzhou Longyuan Athletic — China FA Cup 2026 | FINAL / PARTIAL — score/half rows SETTLED; C05 corners PROVISIONAL WIN |
| `P-234` `[T-011]` | Dalian Yingbo vs Shanghai Shenhua — China FA Cup 2026 | FINAL / PARTIAL — score/half rows SETTLED; C03 corners PROVISIONAL WIN |
| `P-235` `[T-012]` | Shandong Taishan vs Shanghai Port — China FA Cup 2026 | FINAL / PARTIAL — score/half rows SETTLED; C05 corners PROVISIONAL WIN |
...
| `P-239` | Athletics @ Texas Rangers | FINAL / SETTLED (inherited) |
| `P-240` | Chicago White Sox @ Houston Astros | FINAL / SETTLED (inherited) |
| `P-241` | Zachary Svajda vs Daniel Altmaier | FINAL / SETTLED (inherited) |
| `P-242` | Fabian Marozsan vs Michael Zheng | FINAL / SETTLED (inherited) |
| `P-243` | Magda Linette vs Francesca Jones | FINAL / SETTLED (inherited) |
| `P-244` | Baltimore Orioles @ Colorado Rockies | FINAL / SETTLED (inherited) |
| `P-245` | Alexander Zverev vs Lorenzo Sonego | FINAL / SETTLED (inherited) |
| `P-246` | New York Yankees @ Los Angeles Angels | FINAL / CLOSED — no actionable forecast |
| `P-247` | Philadelphia Phillies @ Arizona Diamondbacks | FINAL / SETTLED (inherited) |
| `P-248` | St. Louis Cardinals @ Los Angeles Dodgers | FINAL / SETTLED (inherited) |
| `P-249` | Hanwha Eagles @ KT Wiz | FINAL / CLOSED — no actionable forecast |
| `P-250` | Yunnan Yukun vs Chongqing Tonglianglong | FINAL / SETTLED (inherited) |
| `P-251` | Sassuolo vs Frosinone | FINAL / SETTLED (inherited) |
| `P-252` | Belfast Wolves vs Edinburgh Castle Rockers | FINAL / SETTLED (inherited) |
| `P-253` | El Gounah vs Al Mokawloon Al Arab | FINAL / SETTLED (inherited) |
| `P-254` | Jan Choinski vs Botic Van de Zandschulp | FINAL / SETTLED (inherited) |
| `P-255` | Inter Women vs VfL Wolfsburg Women | FINAL / SETTLED (inherited) |
| `P-256` | Paris Saint-Germain Women vs Eintracht Frankfurt Women | FINAL / SETTLED (inherited) |
| `P-257` | San Diego Padres @ Cincinnati Reds | FINAL / SETTLED (inherited) |
| `P-258` | Atlanta Braves @ Washington Nationals | FINAL / SETTLED (inherited) |
| `P-259` | New York Mets @ Tampa Bay Rays | FINAL / SETTLED (inherited) |
| `P-260` | San Francisco Giants @ Pittsburgh Pirates | FINAL / SETTLED (inherited) |
| `P-261` | Toronto Blue Jays @ Cleveland Guardians | FINAL / SETTLED (inherited) |
| `P-262` | Trinbago Knight Riders vs Antigua & Barbuda Falcons | FINAL / SETTLED (inherited) |
| `P-263` | Jaime Faria vs Carlos Alcaraz | FINAL / SETTLED (inherited) |
| `P-264` | Chicago White Sox @ Houston Astros | FINAL / SETTLED (inherited) |
| `P-265` | Toluca vs Club León | FINAL / SETTLED (inherited) |
| `P-266` | New York Yankees @ Los Angeles Angels | FINAL / SETTLED (inherited) |
| `P-267` | Lanlana Tararudee vs Linda Noskova | FINAL / SETTLED (inherited) |
| `P-268` | Hanwha Eagles @ KT Wiz | FINAL / SETTLED (inherited) |
| `P-269` | KIA Tigers @ NC Dinos — cancelled before first pitch | FINAL / CLOSED — no actionable forecast |
| `P-270` | Canterbury-Bankstown Bulldogs vs Brisbane Broncos | FINAL / SETTLED (inherited) |
| `P-271` | Fremantle vs Hawthorn — AFL first qualifying final | FINAL / SETTLED (inherited) |
| `P-272` | Naomi Osaka vs Katerina Siniakova | FINAL / CLOSED — no actionable forecast |
| `P-273` | Palermo vs Mantova | FINAL / SETTLED — Palermo 5-2 Mantova (HT 2-0); Palermo 3 corners, Mantova 2; Palermo Over 4.5 corners LOSS |
| `P-274` `[T-013]` | San Francisco Giants @ Pittsburgh Pirates | FINAL / RESEARCH SETTLED — listed-pitcher action conditional |
| `P-275` | Alexander Zverev vs Quentin Halys | FINAL / SETTLED (inherited) |
| `P-276` | UAlbany @ Buffalo | FINAL / SETTLED (inherited) |
| `P-277` | Athletics @ Seattle Mariners | FINAL / SETTLED (inherited) |
| `P-278` | St. Louis Cardinals @ Los Angeles Dodgers | FINAL / SETTLED (inherited) |
| `P-279` | Mineros de Zacatecas vs Abejas de León | FINAL / SETTLED (inherited) |
| `P-280` | South Sydney Rabbitohs vs Sydney Roosters | FINAL / SETTLED — Rabbitohs 50–20 Roosters |
| `P-281` | Rakuten Monkeys @ Fubon Guardians | FINAL / SETTLED — Rakuten 0–13 Fubon |
| `P-282` | TSG Hawks @ Uni-Lions | FINAL / SETTLED — TSG 0–11 Uni |
| `P-283` | Namibia vs South Africa — tri-series match 6 | FINAL / SETTLED — South Africa 228/4; Namibia 217/3 (20 overs each) |
| `P-284` | USA vs China — Women’s World Cup | FINAL / SETTLED — USA 94–61 China |
| `P-285` | Korea vs Nigeria — Women’s World Cup | FINAL / SETTLED — Korea 99–81 Nigeria |
| `P-286` | Glasgow Cosmic vs Belfast Wolves — Match 13 | FINAL / SETTLED — Belfast 146/3; Glasgow 120/8 (12 overs each) |
| `P-287` | Alexander Bublik vs Tommy Paul — US Open R3 | FINAL / SETTLED — Paul won 6–4, 3–6, 6–7(4), 6–1, 6–3 |
| `P-288` | Athletics @ Seattle Mariners — September 4 local | FINAL / SETTLED — Athletics 7–6 Mariners; Mariners -1.5 LOSS |
| `P-289` | Western Bulldogs vs Sydney Swans — Round 4 | FINAL / SETTLED — Bulldogs 60–33 Sydney (9.6–5.3) |
| `P-290` | FC Juárez vs Pachuca — Liga MX | FINAL / SETTLED — Pachuca 2–0 Juárez (Rondón 53', Bautista 90+10'); Pachuca Over 0.5 team goals WIN |
| `P-291` | Ben Shelton vs Denis Shapovalov — US Open R3 | FINAL / SETTLED — Shelton d. Shapovalov 7-6(3), 6-7(5), 6-3, 6-4 (25–20 games); Shapovalov +5.5 games WIN |
| `P-292` | Euro-Yroke/St Kilda vs North Melbourne — AFLW | FINAL / SETTLED — North Melbourne 14.15 (99) d. St Kilda 1.1 (7); Under 89.5 LOSS |
| `P-293` | Yartapuulti/Port Adelaide vs Gold Coast — AFLW | FINAL / SETTLED — Gold Coast 2.5 (17) d. Port Adelaide 1.8 (14); Gold Coast +13.5 WIN |
| `LOCAL-GEELONG-20260904` | Geelong Cats vs Carlton — AFL elimination final | FINAL / SETTLED — Geelong 107–74 Carlton |
| `P-294` | Newcastle Knights (W) vs Canterbury-Bankstown Bulldogs (W) — NRLW Round 10 | FINAL / SETTLED — Newcastle 56–22 Canterbury; Under 48.5 LOSS, Knights -15.5 WIN |
| `P-295` | North Queensland Cowboys vs Canberra Raiders — NRL Round 27 | FINAL / SETTLED — Raiders 50–30 Cowboys (major upset, Coby Black debut record); Under 56.5 LOSS, Cowboys -5.5 LOSS |
| `P-296` | Doosan Bears @ SSG Landers — KBO | FINAL / SETTLED — SSG 3–2 Doosan; Under 10.5 WIN, SSG +1.5 WIN |
| `P-297` | Hanwha Eagles @ Lotte Giants — KBO | FINAL / SETTLED — Hanwha 11–6 Lotte; Hanwha ML WIN, Under 11.0 LOSS |
| `P-298` | Brisbane Lions (W) vs GWS GIANTS (W) — AFLW Round 4 | FINAL / SETTLED — Brisbane 7.13 (55) d. GWS 3.6 (24); GWS +29.5 LOSS, Under 95.5 WIN |
| `P-299` | Mali (W) vs Spain (W) — FIBA Women's World Cup Group A | FINAL / SETTLED — Mali 82–73 Spain (major upset); Spain -25.5 LOSS, Under 144.5 LOSS |
| `P-300` | Rotterdam Dockers vs Edinburgh Castle Rockers — ETPL Match 14 | FINAL / SETTLED — ECR 148 (19.3 ov) d. Rotterdam 93 (18 ov) by 55 runs; ECR powerplay 28/3; PP Over 50.5 LOSS, PP Under 50.5 WIN, 20-ov Under 168.5 WIN |
| `P-301` | Cronulla Sharks vs Melbourne Storm — NRL Round 27 | FINAL / SETTLED — Melbourne 24–20 Cronulla (last-second try); Storm -8.5 LOSS, Under 52.5 WIN |
| `P-302` | Newcastle United vs AFC Bournemouth — EPL Matchweek 3 | FINAL / SETTLED — 2-2; Bournemouth 3 corners, Newcastle 4; BOU Over 2.5 corners WIN, 1H Over 0.5 WIN, FT Over 2.5 WIN |
| `P-303` | Nigeria (W) vs Hungary (W) — FIBA Women's World Cup Group B | FINAL / SETTLED — Nigeria 81–53 Hungary; Nigeria +25.5 WIN, Under 145.5 WIN |
| `P-304` | SK Slavia Praha vs FC Zbrojovka Brno — Chance Liga Round 7 | FINAL / SETTLED — Slavia Praha 4–0 Zbrojovka Brno (HT 1-0); 1H Over 0.5 WIN |
| `P-305` | Dublin Guardians vs Amsterdam Flames — ETPL Match 15 | FINAL / SETTLED — Amsterdam Flames 169/7 beat Dublin Guardians 160/8 by 9 runs; AMF powerplay 60/1; PP Over 51.5 WIN |
...
The original 306-row ledger remains historical. The following twelve records extend it to 318 without assigning any additional ID. P-217 is now research settled; P-290, P-304 and P-305 corrections are in the status index. Existing T-001–T-013 are task labels; none is a collision-generated forecast ID.

| ID | Current disposition / rank outcomes | Detail |
|---|---|---|
| P-306 | City 1–0 Coventry; W/L/L/W/L | [Full retrospective](archive/mini_logs/PREDICTION_MINI_LOG_SETTLEMENT_2026-09-06.md#p-306) |
| P-307 | ADMINISTRATIVE / NO FORECAST ISSUED | [Full retrospective](archive/mini_logs/PREDICTION_MINI_LOG_SETTLEMENT_2026-09-06.md#p-307) |
| P-308 | Cerundolo 3–2 Fritz, games 25–23; W/W/L/L | [Full retrospective](archive/mini_logs/PREDICTION_MINI_LOG_SETTLEMENT_2026-09-06.md#p-308) |
| P-309 | Wofford 17–13 Gardner-Webb; W/L/W/L | [Full retrospective](archive/mini_logs/PREDICTION_MINI_LOG_SETTLEMENT_2026-09-06.md#p-309) |
| P-310 | Darderi 3–0 Sweeny, games 18–10; L/L/W/W | [Full retrospective](archive/mini_logs/PREDICTION_MINI_LOG_SETTLEMENT_2026-09-06.md#p-310) |
| P-311 | TKR Women 155 beat Barbados 134, PP 71/1; L/L/W/W | [Full retrospective](archive/mini_logs/PREDICTION_MINI_LOG_SETTLEMENT_2026-09-06.md#p-311) |
| P-312 | Detroit 6–0 Cleveland; W/L/W/L | [Full retrospective](archive/mini_logs/PREDICTION_MINI_LOG_SETTLEMENT_2026-09-06.md#p-312) |
| P-313 | Cincinnati 5–3 Milwaukee; L/L/W/W | [Full retrospective](archive/mini_logs/PREDICTION_MINI_LOG_SETTLEMENT_2026-09-06.md#p-313) |
| P-314 | Angels 6–1 Pittsburgh; W/L/W/L/W/L | [Full retrospective](archive/mini_logs/PREDICTION_MINI_LOG_SETTLEMENT_2026-09-06.md#p-314) |
| P-315 | Melbourne 81–44 West Coast; L/L/W/W | [Full retrospective](archive/mini_logs/PREDICTION_MINI_LOG_SETTLEMENT_2026-09-06.md#p-315) |
| P-316 | SUPERSEDED / ARCHIVAL ONLY, same event as P-317 | [Full retrospective](archive/mini_logs/PREDICTION_MINI_LOG_SETTLEMENT_2026-09-06.md#p-316) |
| P-317 | Doosan 16–9 SSG; L/L/W/W | [Full retrospective](archive/mini_logs/PREDICTION_MINI_LOG_SETTLEMENT_2026-09-06.md#p-317) |
