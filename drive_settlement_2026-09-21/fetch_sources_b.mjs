...
const list=JSON.parse(await fs.readFile(new URL('source_requests_b.json',root),'utf8'));
...
await fs.writeFile(new URL('source_receipts_b.json',root),JSON.stringify(results,null,2));
