...
const list=JSON.parse(await fs.readFile(new URL('source_requests_c.json',root),'utf8'));
...
await fs.writeFile(new URL('source_receipts_c.json',root),JSON.stringify(results,null,2));
