...
| Field                                    | Current value |
| ---------------------------------------- | ------------- |
| As of                                    | **2026-08-29 08:26 Australia/Melbourne — P-133 restoration/settlement addendum; open-state classifications carried from the 08:15 sweep** |
| Previous canonical range                 | `P-001` through `P-123` |
| Highest ID present in this continuation  | **`P-136`** |
| Canonical data-quality exception         | **RESOLVED: `P-133` restored from a user-supplied forecast artifact; provenance is `E1-Q-LATE_IMPORT` because first demonstrable availability in this workspace is post-final** |
...
| New forecast events in this log          | **13** |
| Closed forecast events in this log       | **10** |
| Final unsettled contract rows            | **1 (`P-130-C06` corners — provider/definition not sufficiently frozen for a trustworthy formal grade)** |
| Newly settled ranked rows                | **20 WIN / 19 LOSS / 1 UNSETTLEABLE** across 10 dependent event units; P-133 is descriptive late-import evidence only |
| Newly settled Rank #1                    | **6 WIN / 4 LOSS**; P-133 is excluded from prospective counts |
| Newly settled potential winners          | **9/10 directionally correct descriptively; P-133 Arthur Géa lost; P-130 only as eventual after-extra-time winner, not a 90-minute winner contract** |
...
**Canonical continuation rule:** use `P-137` for the next new event. `P-133` is now restored in sequence, but remains `E1-Q-LATE_IMPORT` for evaluation provenance unless an earlier immutable pre-result artifact is later supplied.
...
State checked at the 2026-08-29 08:15 Australia/Melbourne audit cutoff.

| Canonical ID | Sport / competition | Event | View | GAME-STATE | Scheduled start / observation | Status |
| ------------ | ------------------- | ----- | ---- | ---------- | ----------------------------- | ------ |
| `P-126` | Soccer — SFA A Division S-League | Sikkim Aakraman FC vs Sikkim Boys Club | V01 | `PREGAME / SCHEDULE FIELD-OWNER UNRESOLVED` | Current score feeds list **2026-08-29 05:30 UTC / 15:30 Melbourne** | **OPEN — PREGAME** |
| `P-135` | Soccer — Argentina Torneo Clausura | Unión de Santa Fe vs Sarmiento | V01 | `LIVE — SECONDARY STATE OBSERVED; OFFICIAL LIVE CONTROL NOT RECOVERED` | ESPN exposed **0-0 at 2'** during the audit | **OPEN — LIVE; DO NOT SETTLE** |
| `P-136` | Tennis — ATP Winston-Salem | James Duckworth vs Arthur Fery | V01 | `PREGAME` | Listed as upcoming; original log: not before **08:30 Melbourne** | **OPEN — PREGAME** |

`P-133` is not in the active queue. It has now been restored and settled as a **closed late-import record**; its first demonstrable artifact in this workspace is post-final.
...
| ------------ | ----- | ----------- | ----- | ---- | ------------- | ------- | ---------------- | -------------- |
| `P-124` | Tennis | ITF M15 Maanshan | Chase Ferguson vs Fumin Jiang | V01 | Pregame / state-limited | Chase Ferguson ML | Chase Ferguson | **CLOSED — Ferguson won 5-7, 6-4, 6-3** |
| `P-125` | Ice hockey | AIHL Goodall Cup | Canberra Brave vs Sydney Bears | V01 | Pre-start / live-state-limited | Sydney Bears +1.5 | Canberra Brave | **CLOSED — Canberra 4-3 Sydney** |
| `P-126` | Soccer | SFA A Division S-League | Sikkim Aakraman FC vs Sikkim Boys Club | V01 | Pregame / schedule conflict | Sikkim Aakraman ML | Sikkim Aakraman | **OPEN — PREGAME** |
| `P-127` | Basketball | FIBA WC 2027 Asian Qualifiers | Iran vs New Zealand | V01 | Pregame | Iran +7.5 | New Zealand | **CLOSED — New Zealand 93-91 OT** |
| `P-128` | Rugby union | Hilux NPC | Auckland vs Bay of Plenty | V01 | Pregame | Over 60.0 | Bay of Plenty | **CLOSED — Bay of Plenty 22-19** |
| `P-129` | Rugby league | NRL | Manly Sea Eagles vs St George Illawarra Dragons | V01 | Pregame | Manly +10.5 | Manly | **CLOSED — Manly 44-10** |
| `P-130` | Soccer | Israel State Cup | Beitar Haifa Yakov vs Hapoel Bnei Arrara Ara | V01 | Pre-start/state-limited | Beitar or Draw 1X | Beitar Haifa Yakov | **CLOSED — 1-1 after 90; Beitar 3-1 AET; one corner row UNSETTLEABLE** |
| `P-131` | Rugby league | NRL | Penrith Panthers vs Canterbury Bulldogs | V01 | Pregame | Bulldogs +9.5 | Penrith | **CLOSED — Penrith 24-10** |
| `P-132` | Rugby sevens | In Extenso SuperSevens | RC Vannes Sevens vs LOU Rugby Sevens | V01 | Pregame | Under 35.5 | Vannes | **CLOSED — Vannes 17-10** |
| `P-133` | Tennis | US Open Men's Qualifying | Arthur Géa vs Nishesh Basavareddy | V01 | Claimed pregame; first demonstrable artifact post-final | Arthur Géa -2.5 games | Arthur Géa | **CLOSED — Basavareddy won 6-3, 6-1; `E1-Q-LATE_IMPORT`** |
| `P-134` | Basketball | FIBA WC 2027 African Qualifiers | Cape Verde vs Guinea | V01 | Pregame | Cape Verde +10.5 | Guinea | **CLOSED — Guinea 81-61** |
| `P-135` | Soccer | Argentina Torneo Clausura | Unión de Santa Fe vs Sarmiento | V01 | Start crossed / state unresolved | Sarmiento TT O0.5 | Sarmiento | **OPEN — LIVE; 0-0 at 2' observed on ESPN during audit** |
| `P-136` | Tennis | ATP Winston-Salem | James Duckworth vs Arthur Fery | V01 | Pregame | Over 22.5 games | Arthur Fery | **OPEN — PREGAME** |

**P-133 restoration note:** the record is now present in canonical sequence but is tagged `E1-Q-LATE_IMPORT`; descriptive settlement counts above include it, while prospective evaluation counts must exclude it.
...
# P-133 — Arthur Géa vs Nishesh Basavareddy — US Open 2026 Men's Qualifying Final
...
| **1** | **Arthur Géa -2.5 Games** | **LEAN** | **MEDIUM-HIGH** |

| **2** | **Total Games Over 22.5** | **LEAN** | **MEDIUM** |

| **3** | **Total Games Under 22.5** | **FORCED RANK** | **MEDIUM** |

| **4** | **Nishesh Basavareddy +2.5 Games** | **AVOID** | **MEDIUM-HIGH** |

**Potential match winner:** **Arthur Géa — LEAN**

### Short conclusion

Géa has the stronger current hard-court profile and the clearer return advantage. He is also the No. 1 qualifying seed, recently won his first ATP title in Los Cabos, and has won seven consecutive hard-court matches entering this qualifier. In six of those seven wins, his final game margin exceeded 2.5.

Basavareddy is not a weak opponent: he is 2-0 in US Open qualifying this week, owns a strong recent hard-court hold rate, and has enough serve/tiebreak resilience to create a close-set or three-set match. That is why **Over 22.5** ranks second and why the Géa handicap is a lean rather than a high-confidence call.
...
| Competition | 2026 US Open Men's Singles Qualifying |

| Round | Qualifying Round 3 / Final Qualifying Round |

| Event | Arthur Géa vs Nishesh Basavareddy |
...
| Scheduled start | 2026-08-28 11:00 ET / 15:00 UTC |

| Melbourne equivalent | 2026-08-29 01:00 AEST |

| Final pregame refresh | 2026-08-29 00:25:57 Australia/Melbourne |

| GAME-STATE | `PREGAME / NOT STARTED` |

| Géa draw seed | `1` |

| Basavareddy draw seed | `32` |

| Current ranking context | Géa ~ATP 86; Basavareddy ~ATP 163 |
...
- exact event, round, surface, format and participant identity;

- retirement/walkover terms treated as contract-specific;

- current surface form separated from broad ranking/reputation;

- opponent-adjusted serve and return process where reliable;

- hold/break, first/second-serve and tiebreak exposure considered together;

- H2H used only when genuine continuity exists;

- one coherent match tree for winner, handicap and total games;

- explicit straight-set and three-set branches for best-of-three totals;

- qualifying workload treated as exposure/variance, not automatically as fatigue;

- no numerical probability publication because no approved/fitted tennis model exists.

Relevant promoted process controls include event/contract freeze, one coherent distribution, exact threshold classification, regime reconciliation, marginal-likelihood ranking and final volatile-state refresh.

---

# Frozen decision set

**Decision-set ID:** `DS-P-133-V01`
...
| `P-133-C01` | Arthur Géa -2.5 Games |

| `P-133-C02` | Nishesh Basavareddy +2.5 Games |

| `P-133-C03` | Total Games Over 22.5 |

| `P-133-C04` | Total Games Under 22.5 |

### Contract geometry

The game handicaps are exact half-game opposites:

- **Géa -2.5 wins** if Géa finishes at least 3 games ahead.

- **Basavareddy +2.5 wins** if Basavareddy wins the match or loses by no more than 2 games.

The total is an exact half-game pair:

- **Over 22.5 wins:** 23+ total games.

- **Under 22.5 wins:** 22 or fewer total games.

No push exists on the supplied thresholds.

### Retirement / walkover terms

The user did not supply an operator.

Therefore exact retirement and walkover settlement for handicap and total-games markets is:

`UNKNOWN_DEFINITION`

No value claim is made.

---

# Official event identity and state

The official US Open men's qualifying draw lists:

**Arthur Géa [1] vs Nishesh Basavareddy [32]**

in **Qualifying Round 3**, the final qualifying round, on **Court 12**.

The winner advances into the US Open main draw.

Current structured tournament data and multiple current schedule sources list the rescheduled match for:

**28 August 2026 — 11:00 AM New York / 15:00 UTC**

At the final research refresh, the current time was:

**10:25 AM New York / 00:25 Melbourne**

and current score feeds still listed the match as **not started**.

This is therefore a valid pregame forecast.
...
- Current ranking around No. 86

- No. 1 seed in US Open qualifying

- Career-high ranking in the low-to-mid 80s during August 2026

- First ATP Tour title won at Los Cabos in early August

### Recent hard-court form

Géa's current seven-match hard-court winning sequence:

| Match | Score | Game margin | Total |

|---|---|---:|---:|

| vs Soonwoo Kwon | 6-4, 6-7, 6-2 | +5 | 31 |

| vs Michael Zheng | 0-6, 6-4, 6-0 | +2 | 22 |

| vs Francisco Cerúndolo | 6-7, 6-4, 6-0 | +7 | 29 |

| vs Coleman Wong | 7-6, 6-3 | +4 | 22 |

| vs Denis Shapovalov | 6-3, 6-4 | +5 | 19 |

| vs Sumit Nagal | 6-3, 7-6 | +4 | 22 |

| vs Clément Chidekh | 6-4, 6-7, 6-2 | +5 | 31 |

Descriptively:

- 7 straight hard-court wins;

- Géa -2.5 would have won in **6 of 7**;

- 3 of 7 went above 22.5 games;

- 4 of 7 stayed at 22 or below.

These are descriptive threshold classifications, not probabilities.

### Current hard-court process

Recent Tennis Abstract hard-court split:

- win record approximately **35-9**

- hold rate approximately **85.4%**

- service points won approximately **66.1%**

- break rate approximately **33.5%**

- return points won approximately **42.6%**

- dominance ratio approximately **1.26**

The critical signal is not merely the win record. It is the combination of a stable hold base with a substantially stronger return/break profile than Basavareddy's current hard-court split.
...
- Current ranking around No. 163

- No. 32 seed in US Open qualifying

- Career high No. 99

### Current US Open qualifying

Round 1:

**Basavareddy def. Moïse Kouamé 7-6(3), 4-6, 6-3**
...
**Basavareddy def. Luka Mikrut 6-2, 6-4**

- total games: 18

- match margin: +6

So Basavareddy has shown both:

- a close three-set/tiebreak branch;

- a clean straight-set branch.

### Current/recent hard-court process

Tennis Abstract current hard split:

- record approximately **23-16** in the recent hard sample;

- hold rate approximately **82.4%**

- service points won approximately **65.1%**

- break rate approximately **21.1%**

- return points won approximately **36.4%**

- dominance ratio approximately **1.04**

Basavareddy's serve is good enough to keep sets close, but his return/break profile is materially weaker than Géa's.

This is the core matchup difference.

---

# Current US Open qualifying performance

## Géa

Round 1:

**def. Sumit Nagal 6-3, 7-6(4)**
...
**def. Clément Chidekh 6-4, 6-7(4), 6-2**
...
**def. Moïse Kouamé 7-6(3), 4-6, 6-3**

- total games: 32

- Basavareddy margin: +2
...
**def. Luka Mikrut 6-2, 6-4**

- total games: 18

- Basavareddy margin: +6

- straight sets

### Immediate workload

Both players have already played two qualifying matches in New York.
...
There is no clear workload asymmetry large enough to justify a one-direction fatigue adjustment.

---

# Ranking and current-regime reconciliation
...
- qualifying seed No. 1

- ATP title winner this month

Basavareddy:

- ~No. 163

- qualifying seed No. 32

- former Top-100 player

Ranking alone is insufficient under the Drive rules.

## Current regime

Géa's ranking advantage is reinforced rather than contradicted by current hard-court performance:

- current hard winning streak;

- recent ATP title;

- stronger return-points profile;

- substantially higher break rate;

- six covers of a -2.5 threshold across the last seven hard wins.

Basavareddy's current form is also positive:

- two qualifier wins;

- strong hold rate;

- current hard-court tiebreak resilience;

- previous Top-100 level and capacity to extend stronger opponents.

Therefore the correct interpretation is:

**Géa has the stronger central match state, but Basavareddy has enough serve/close-set stability to preserve a meaningful long-match and narrow-margin tail.**

---

# Head-to-head audit

There are **no prior meetings** between Arthur Géa and Nishesh Basavareddy in the current H2H database.

Therefore:

- no H2H score is used;

- no old-surface meeting is imported;

- the matchup is built from current surface serve/return evidence instead.
...
Géa's recent hard-court hold rate is roughly 85%.

Basavareddy's recent hard return profile breaks at only around 21%.

This creates a strong Géa hold branch and reduces Basavareddy's ordinary path to repeated breaks.

## Basavareddy serving

Basavareddy's hard hold rate is also strong, around 82%.

However, Géa's return profile is the difference:

- Géa recent hard break rate ~33.5%

- Géa return points won ~42.6%

That is materially stronger than Basavareddy's own return profile.

### Matchup implication

The central mechanism is:

`Géa protects serve at a high rate + Géa creates materially more return pressure -> one break per set becomes more available to Géa than to Basavareddy`
...
But Basavareddy's own hold strength means:
...
remain realistic, which supports the Over branch.

---

# Total-games tree

## Straight-set Géa control branch
...
This is the strongest Under mechanism.

---

## Tight straight-set branch
...
The 7-6, 7-6 branch is especially important because Géa can win the match while **failing -2.5** on total game margin (+2).
...
- Géa -2.5 often, but not always

Géa has played four three-set matches in his current seven-match hard winning streak, so this branch cannot be treated as a remote tail.

---

## Basavareddy upset / long-match branch

Representative:

- 7-6, 4-6, 6-4 Basavareddy

- 6-4, 3-6, 7-5 Basavareddy
...
This is the main kill path for the rank-1 handicap.

---

# Why Over 22.5 narrowly ranks above Under 22.5

The current qualifying totals are split:
...
So no trend alone resolves the total.

The reason the Over gets a slight qualitative edge is structural:

1. Both players have hard-court hold rates above ~82%.

2. Basavareddy is good enough on serve to force at least one 6-4/7-5/tiebreak-type set.

3. Both have already played a deciding-set qualifier this week.

4. A three-set match usually clears 22.5 comfortably.

5. Géa's recent hard streak includes multiple three-set wins.

6. A tight straight-set result such as 7-6, 6-4 also clears 22.5.

The strongest Under counterargument is Géa's much better return profile. If he repeatedly breaks Basavareddy early enough, scores such as 6-3, 6-4 or 6-4, 6-4 keep the match below the line.
...
- current ranking advantage;

- No. 1 qualifying seed;

- first ATP title this month at Los Cabos;

- seven-match current hard-court winning streak;

- stronger recent hard-court hold/break combination;

- materially stronger return points won;

- 2-0 in New York qualifying;

- no current official withdrawal or injury flag found at the final refresh.

### Strongest failure path

Basavareddy serves at the upper end of his hard-court range, limits Géa's break opportunities, wins a tiebreak/close first set and turns the match into a pressure-heavy three-set qualifier in front of a home crowd.

That branch is credible enough to keep the winner at `LEAN`, not `SUPPORTED`.
...
| **1** | `P-133-C01` | **Arthur Géa -2.5 Games** | `LEAN` | `MEDIUM-HIGH` | `MATCH / GAME MARGIN` | `NOT_GENERATED` |

| **2** | `P-133-C03` | **Over 22.5 Games** | `LEAN` | `MEDIUM` | `MATCH / SET COUNT / GAME TOTAL` | `NOT_GENERATED` |

| **3** | `P-133-C04` | **Under 22.5 Games** | `FORCED RANK` | `MEDIUM` | `MATCH / SET COUNT / GAME TOTAL` | `NOT_GENERATED` |

| **4** | `P-133-C02` | **Basavareddy +2.5 Games** | `AVOID` | `MEDIUM-HIGH` | `MATCH / GAME MARGIN` | `NOT_GENERATED` |

---

# Detailed ranking rationale

## #1 — Arthur Géa -2.5 Games

The strongest supplied contract.

Géa's current surface regime shows:

- stronger hold/break combination;

- better return-pressure profile;

- an ATP-title-level hard-court run;

- six covers of -2.5 in his last seven hard-court wins.

A straight-set win of 6-4, 6-4 or better covers comfortably, and many of his three-set wins also produce a 3+ game margin.

**Strongest kill path:** two tiebreak/close sets or a three-set match where the set scores offset enough to keep Géa's net game margin at +1 or +2.

---

## #2 — Over 22.5 Games

The Over is linked to Basavareddy's most credible resistance pathway.

He does not need to win:

- one tiebreak plus a 6-4 set can already produce 23 games;

- a competitive three-set match usually clears the threshold;

- both players have displayed tiebreak/three-set exposure during the current qualifying run.

**Strongest kill path:** Géa's return edge converts into multiple early breaks and a controlled 6-3, 6-4 / 6-4, 6-4 straight-set win.

---

## #3 — Under 22.5 Games

The Under has a very real path:

- Géa is the better returner;

- four of his last seven hard wins finished at 22 games or fewer;

- his Q1 win this week was exactly 22;

- Basavareddy's Q2 was only 18.

It remains below the Over because Basavareddy's hold rate, tiebreak resilience and deciding-set pathway make 23+ marginally more robust in the qualitative tree.

---

## #4 — Nishesh Basavareddy +2.5 Games

Basavareddy has a credible upset and close-loss branch, so this is not a dismissal of his ability.

But the exact contract requires the match to remain extremely close in net game margin.

A Géa straight-set win of:
...
all defeats Basavareddy +2.5.

The current hard-court return differential gives Géa more routes to that margin than Basavareddy has to stay within two.

`AVOID` is evidence-relative only and is not an expected-value statement.

---

# Current market-state note — excluded from sporting probability

A current market aggregator showed:

- Géa as a modest match favourite;

- a main total around **23.5 games**.

The user supplied **22.5**, which is therefore a lower alternate threshold in that reference market.

This is recorded only as market/contract context.

The market price and implied probability were **not** used as the internal sports forecast.
...
- US Open official men's qualifying draw — event, round, Court 12, seeds, upcoming state

- ATP Tour US Open draw/results — exact Q1/Q2 scores

- ATP Tour Los Cabos final report — Géa's first ATP Tour title

- Australian Open player profiles — current player identity/ranking context

## Specialist statistical sources

- Tennis Abstract — recent hard-court serve/return/hold/break/dominance splits

- TennisDB / Tennis Explorer — current match logs and cross-check of recent hard results

- current structured tennis schedule/H2H source — first-meeting confirmation and rescheduled start

## Market-state source

- current market aggregator used only to cross-check scheduled time and alternate-total context

### Source limitations

- No operator was supplied, so retirement/walkover settlement is unknown.

- No validated Tennis Research numerical model exists.

- Recent hard-court statistical windows are not perfectly identical across providers.

- No prior H2H exists.

- No current verified injury report gives either player a material fitness downgrade; absence of a current flag is not proof of perfect health.
...
**GAME-STATE at final refresh:** `PREGAME / NOT STARTED`
...
**Important:** This file freezes the pregame evidence state at 00:25:57 Australia/Melbourne, about 34 minutes before the currently listed 01:00 Melbourne start. If the match has started when this file is opened, it should not be reinterpreted as a live forecast.


---

## Provenance addendum — supplied after final

This P-133 forecast artifact was supplied to the current workspace by the user on **2026-08-29 after the match had already finished**. Its embedded card states a pregame refresh of **2026-08-29 00:25:57 Australia/Melbourne**, but the current workspace does not independently demonstrate that this exact artifact was stored before the result.

Accordingly, preserve the forecast text and claimed pregame timestamp, but classify its evaluation provenance as:

`E1-Q-LATE_IMPORT — FIRST DEMONSTRABLE ARTIFACT POST-FINAL`

This does **not** prevent descriptive settlement or retrospective analysis. It does prevent P-133 from entering prospective performance, calibration, model-promotion, or prospective-test counts unless an earlier immutable pre-result artifact is later supplied and verified.
...
# Settlement and state sweep — 2026-08-29 08:15 Australia/Melbourne

## Scope and integrity boundary

This sweep settles every event in this continuation that could be verified final at the audit cutoff and leaves live/pregame events open. It does not rewrite any issued forecast.

The predecessor `PREDICTION_LOG_COMBINED.md` remains the historical record through `P-123`; its controlling snapshot had no inherited open event before `P-124`.

The supplied continuation contains forecasts for `P-124` through `P-136` **except `P-133`, which is absent**. No event is invented for that ID.

### Sweep ledger

| Measure | Result |
|---|---:|
| Forecast events present in continuation | 12 |
| Newly closed in this sweep | 9 |
| Open pregame | 2 |
| Open live | 1 |
| Missing canonical ID | 1 (`P-133`) |
| Settled ranked rows | 35 |
| Ranked-row wins | 18 |
| Ranked-row losses | 17 |
| Unsettleable ranked rows | 1 |
| Rank #1 | 6-3 |
| Rank #2 | 5-4 |
| Rank #3 | 4-5 |
| Rank #4 | 3-5-1 UNSETTLEABLE |
| Potential-winner direction | 9/9 across the nine newly closed events; descriptive only, dependent, not calibration or profitability |

These counts are descriptive bookkeeping only. They are not independent trials, calibrated probabilities, ROI, expected value, or evidence of market edge.

---

# P-124 settlement — Chase Ferguson vs Fumin Jiang

## Verified final

**Chase Ferguson defeated Fumin Jiang 5-7, 6-4, 6-3.**

The match lasted approximately 2h59. The recovered match-stat page reports Ferguson winning 40/58 first-serve points and 21/36 second-serve points, versus Jiang 41/59 and 18/37 respectively; Ferguson converted 4/5 break points versus Jiang 2/3.

### Contract settlement

| Rank | Contract ID | Exact contract | Outcome | Settlement |
|---:|---|---|---|---|
| 1 | `P-124-C01` | Chase Ferguson — Match Winner | **WIN** | Ferguson won 2-1 |
| 2 | `P-124-C03` | Chase Ferguson — 1st Set Winner | **LOSS** | Jiang won set 1, 7-5 |
| 3 | `P-124-C06` | Fumin Jiang +5.5 Games | **WIN** | Ferguson won games 17-14; Jiang +5.5 covers |
| 4 | `P-124-C07` | Chase Ferguson -1.5 Sets / Ferguson 2-0 | **LOSS** | Match went three sets |
| — | Winner alias | Chase Ferguson | **WIN** | Canonical winner `P-124-C01` |

## Retrospective

| Preissue expectation | Actual driver | Difference | Knowability | Process grade | Defect class | Lesson/test | Method change |
|---|---|---|---|---|---|---|---|
| Ferguson stronger overall; Jiang had a material set-winning/close-match branch | Jiang took the first set; Ferguson recovered over three sets and won | Winner and Jiang-cushion branches were right; first-set and straight-set branches were too aggressive | The three-set risk was explicitly knowable and already modelled from both prior same-venue H2Hs and Jiang's current form | `COMPLIANT` | `NONE — OUTCOME/RANKING VARIANCE` | Reinforce tennis shared match-tree separation between match winner, first set and straight-sets | **No weight/rule change** |

### What went right

- Rank #1 correctly avoided requiring a straight-set win.
- The card explicitly said Jiang's current regime increased the set-winning branch; that is exactly what occurred.
- Jiang +5.5 was correctly separated from Jiang moneyline and won in the same match as Ferguson ML.

### What went wrong / improvement

- Ferguson first-set ML leaned too much on two old same-venue first-set wins. Jiang's current tournament form was already strong enough to make this branch less robust.
- The `Ferguson 2-0` row was correctly ranked fourth, but the evidence never supported elevating it beyond a thin lean given both prior H2Hs went three sets.
- No new rule is justified; the existing tennis requirement to derive winner/set handicap/total from one match tree is sufficient.

**Sources**
- TennisTonic result/stat page: https://tennistonic.com/stat-tournaments/atp/21994/51259-106252/fumin-jiang-vs-chase-ferguson/

---

# P-125 settlement — Canberra Brave vs Sydney Bears

## Verified final

**Canberra Brave defeated Sydney Bears 4-3.**

Period scores were **1-1, 1-1, 2-1**. Shots on goal were **Canberra 41, Sydney 29**.

### Contract settlement

| Rank | Contract ID | Exact contract | Outcome | Settlement |
|---:|---|---|---|---|
| 1 | `P-125-C02` | Sydney Bears +1.5 | **WIN** | Sydney lost by one |
| 2 | `P-125-C03` | Over 8.5 Goals | **LOSS** | 7 total goals |
| 3 | `P-125-C01` | Canberra Brave -1.5 | **LOSS** | Canberra won by one |
| 4 | `P-125-C04` | Under 8.5 Goals | **WIN** | 7 total goals |
| — | Winner alias | Canberra Brave | **WIN** | Canberra advanced |

## Retrospective

| Preissue expectation | Actual driver | Difference | Knowability | Process grade | Defect class | Lesson/test | Method change |
|---|---|---|---|---|---|---|---|
| Canberra had stronger shot/process edge; Sydney +1.5 could coexist with Canberra winner; Over was favoured but goalie/state uncertainty was material | Canberra won by one despite a 41-29 SOG edge; total stayed at seven | Margin tree was excellent; total direction missed because shot advantage did not convert into nine goals | Low-goal 4-3/5-3 branch was explicitly listed as the Over kill path; starting goalies were unresolved | `COMPLIANT — STATE LIMITED` | `NONE` | Reinforce shot volume ≠ goal conversion; goalie/finishing uncertainty must widen total branches | **No rule change** |

### What went right

The exact joint state `Canberra winner + Sydney +1.5` was identified pregame and realised. The margin read was stronger than a simple favourite/underdog narrative.

### What went wrong / improvement

The Over leaned too heavily on recent high-scoring results and special-teams/shot-volume upside. The final showed that a clear shot edge can still coexist with a sub-8.5 goal total. Because the card explicitly quarantined the unverified goalie state and named 4-3 as the kill path, this is not a compliance defect.

**Sources**
- Ice Hockey News Australia result with AIHL game-card link: https://icehockeynewsaustralia.com/2026/08/28/2026-goodall-cup-playoffs-canberra-brave-defeat-sydney-bears-in-the-preliminary-round-to-advance/

---

# P-127 settlement — Iran vs New Zealand

## Verified final

**New Zealand defeated Iran 93-91 in overtime.**

Quarter scores:
- Iran: 19, 20, 22, 19, OT 11
- New Zealand: 21, 17, 28, 14, OT 13

Regulation ended **80-80**, so regulation scoring was already **160 points** before overtime. New Zealand shot 45% overall and 64.1% on two-pointers; Iran shot 41% overall and 45.2% on two-pointers.

### Contract settlement

| Rank | Contract ID | Exact contract | Outcome | Settlement |
|---:|---|---|---|---|
| 1 | `P-127-C02` | Iran +7.5 | **WIN** | Iran lost by 2 |
| 2 | `P-127-C04` | Under 158.5 | **LOSS** | 184 full-game points; 160 already in regulation |
| 3 | `P-127-C03` | Over 158.5 | **WIN** | 184 full-game points |
| 4 | `P-127-C01` | New Zealand -7.5 | **LOSS** | New Zealand won by only 2 |
| — | Winner alias | New Zealand | **WIN** | NZ won in OT |

## Retrospective

| Preissue expectation | Actual driver | Difference | Knowability | Process grade | Defect class | Lesson/test | Method change |
|---|---|---|---|---|---|---|---|
| Close NZ-favoured game; Iran +7.5 robust; Under slightly preferred with an explicit late-foul/OT kill path | Game was exactly close, but scoring reached 160 in regulation and OT added 24 more; NZ's 28-point third quarter drove the regulation Over | Side/margin tree was strong; total central corridor was ~1.5 points too low even before OT | Overtime/late scoring was explicitly modelled; the regulation total was boundary-sensitive | `COMPLIANT` | `NONE — BOUNDARY/TOTAL VARIANCE` | Keep overtime as explicit tail but audit regulation total separately from OT contribution | **No rule change** |

### What went right

- Iran +7.5 was correctly ranked first.
- Potential winner New Zealand was correctly separated from New Zealand -7.5.
- The central `NZ wins by 1-7` branch was essentially exact.

### What went wrong / improvement

The Under was not only beaten by overtime: the regulation game finished 80-80, already 1.5 points above the line. Future retrospectives must not attribute a total loss to OT when the threshold had already been crossed in regulation.

**Sources**
- Official FIBA game page: https://www.fiba.basketball/en/events/fiba-basketball-world-cup-2027-asian-qualifiers/games/126979-IRI-NZL

---

# P-128 settlement — Auckland vs Bay of Plenty

## Verified final

**Bay of Plenty defeated Auckland 22-19.**

The game was tied **19-19** late before Riley Hohepa kicked the decisive penalty. Total points: **41**.

### Contract settlement

| Rank | Contract ID | Exact contract | Outcome | Settlement |
|---:|---|---|---|---|
| 1 | `P-128-C03` | Over 60.0 Points | **LOSS** | 41 total |
| 2 | `P-128-C01` | Auckland +4.5 | **WIN** | Auckland lost by 3 |
| 3 | `P-128-C04` | Under 60.5 Points | **WIN** | 41 total |
| 4 | `P-128-C02` | Bay of Plenty -4.5 | **LOSS** | Bay won by 3 |
| — | Winner alias | Bay of Plenty | **WIN** | Bay won 22-19 |

## Rank-1 loss audit

The issued #1 Over relied materially on:
- Auckland 3/4 prior games above 60;
- Bay of Plenty 3/4 above 60;
- a broad NPC scoring average near 61.6;
- no strong weather-suppression signal.

The card also explicitly identified the kill path:
> historically tight territorial regime + inefficient opposition-22 conversion -> roughly 27-24.

The final was even lower at 22-19 and the +4.5 margin branch was correct.

### Why #1 was over-ranked

The pregame evidence did **not** contain enough current, matchup-specific scoring-process evidence to justify letting broad recent total counts outrank the direct low-total continuity and conversion uncertainty. The log itself stated there was **no dedicated rugby-union module** and that exact official player lists were not recovered directly.

That is a process issue, not merely bad luck: the ranking used outcome-frequency/competition-average evidence more strongly than the available sport-native mechanism justified.

## Retrospective

| Preissue expectation | Actual driver | Difference | Knowability | Process grade | Defect class | Lesson/test | Method change |
|---|---|---|---|---|---|---|---|
| Close game with high-scoring central branch | Close game occurred, but scoring remained far below the 60 threshold | Margin mechanism right; total mechanism overfit broad 2026 scoring environment | The low-total H2H/conversion branch and lack of a dedicated rugby-union module were known preissue | `PROCESS_DEFECT` | `OUTCOME-STAT SUBSTITUTION / SPORT-MODULE EVIDENCE CAP` | `C-P128-RU-TOTAL-MECHANISM` — broad Over rates must not control rugby-union totals without matchup-native scoring-process support | **Candidate learning only; no fitted weight change** |

**Sources**
- RugbyPass final and scoring sequence: https://www.rugbypass.com/live/auckland-vs-bay-of-plenty/
- RugbyPass stats shell: https://www.rugbypass.com/live/auckland-vs-bay-of-plenty/stats/

---

# P-129 settlement — Manly Sea Eagles vs St George Illawarra Dragons

## Verified final

**Manly defeated the Dragons 44-10.**

Official NRL reporting records:
- Dragons: **15 errors**
- Dragons completion: **62%**
- Manly led the possession/territory battle heavily; at halftime Manly had **63% possession** and **88% completion**
- Manly scored **nine tries**
- Manly's back five scored seven of those tries.

### Contract settlement

| Rank | Contract ID | Exact contract | Outcome | Settlement |
|---:|---|---|---|---|
| 1 | `P-129-C01` | Manly +10.5 | **WIN** | Manly won outright |
| 2 | `P-129-C04` | Under 50.5 | **LOSS** | 54 total |
| 3 | `P-129-C03` | Over 50.0 | **WIN** | 54 total |
| 4 | `P-129-C02` | Dragons -4.5 | **LOSS** | Dragons lost by 34 |
| — | Winner alias | Manly | **WIN** | Manly won 44-10 |

## Retrospective and pregame-error audit

The side/winner analysis was strong. The total analysis contained a specific structural mistake.

The issued Under kill path said the Over needed Manly's restored attack **and Manly's defence conceding enough** for 51+. That was too narrow. The actual game crossed the total with the Dragons contributing only 10 points because Manly alone scored 44 off repeated short fields, errors and broken defensive states.

The active rugby-league rules already require a possession-native blowout branch in which repeated short fields and separation can increase the favourite's score while suppressing the underdog contribution. That branch was not weighted strongly enough in the total ranking.

## Retrospective

| Preissue expectation | Actual driver | Difference | Knowability | Process grade | Defect class | Lesson/test | Method change |
|---|---|---|---|---|---|---|---|
| Manly preferred; Under central because Dragons attack weak and season environments near mid-40s | Dragons' 15 errors/62% completion gave Manly repeated possession and short-field opportunities; Manly reached 44 by themselves | Side tree correct; total tree incorrectly tied the Over too strongly to two-team scoring | Favourite-only blowout was a known framework branch and should have been stressed | `PROCESS_DEFECT` | `DEPENDENCE / BLOWOUT-TAIL UNDERWEIGHTING` | Reinforce `RULES_NRL_RUGBY` blowout branch: favourite offensive dominance can carry an Over even with underdog suppression | **Enforcement correction only; no new coefficient** |

**Sources**
- Official NRL live/final report: https://www.nrl.com/news/2026/08/28/friday-night-lights-sea-eagles-v-dragons-panthers-v-bulldogs/

---

# P-130 settlement — Beitar Haifa Yakov vs Hapoel Bnei Arrara Ara

## Verified result boundary

Recovered current result sources agree that **90 minutes ended 1-1**. A secondary match detail page reports:
- halftime: **0-1**
- 90-minute FT: **1-1**
- after extra time: **Beitar Haifa Yakov 3-1**, with extra-time goals at 98' and 119'.

The exact corner-provider definition was **not frozen** in the forecast and no sufficiently authoritative provider record was recovered for formal corner settlement. The corner row therefore remains `UNSETTLEABLE`, even though secondary sites may display a corner count.

### Contract settlement

| Rank | Contract ID | Exact contract | Outcome | Settlement |
|---:|---|---|---|---|
| 1 | `P-130-C01` | Beitar Haifa Yakov or Draw — Double Chance 1X | **WIN** | 90 minutes ended 1-1 |
| 2 | `P-130-C02` | 1st Half Goals Over 0.5 | **WIN** | HT 0-1 |
| 3 | `P-130-C04` | Combined Total Goals Over 2.5 | **LOSS** | Regulation FT 1-1 = 2 goals |
| 4 | `P-130-C06` | Total Corners Under 10.5 — research threshold | **UNSETTLEABLE** | Provider/definition not sufficiently frozen/recovered |
| — | Potential winner | Beitar Haifa Yakov | **DIRECTIONALLY CORRECT EVENTUAL WINNER** | Beitar won 3-1 after extra time; this is **not** a 90-minute winner-contract win |

## Retrospective

| Preissue expectation | Actual driver | Difference | Knowability | Process grade | Defect class | Lesson/test | Method change |
|---|---|---|---|---|---|---|---|
| Beitar non-loss strongest; first-half goal favoured; 3+ regulation goals only thin lean | Hapoel scored first; Beitar equalised; regulation stayed 1-1; Beitar separated only in extra time | 1X and 1H goal correct; O2.5 overestimated regulation finishing; eventual winner correct only after ET | Sparse participants, schedule conflict and provider limits were disclosed before issue | `INCONCLUSIVE — STATE/DEFINITION LIMITED` | `NONE FOR GOALS; CORNER SETTLEMENT DEFINITION MISSING` | Keep regulation-vs-extra-time endpoints explicit; niche row remains unsettleable without provider | **No rule change** |

### Important integrity note

Do **not** convert the after-extra-time 3-1 into a win for the regulation Over 2.5. The regulation target ended at 1-1.

**Sources**
- Regulation result cross-check: https://tips.gg/archive/beitar-haifa-yakov-football-vs-hapoel-bnei-arrara-ara-football/
- AET/HT event detail: https://pglive.ph/match/3073252/beitar-haifa-yakov-vs-hapoel-bnei-arrara-ara

---

# P-131 settlement — Penrith Panthers vs Canterbury-Bankstown Bulldogs

## Verified final

**Penrith defeated Canterbury 24-10.**

Official NRL reporting:
- Penrith completed **38 of 41 sets**.
- Penrith were **22/22 completions at halftime**.
- Nathan Cleary repeatedly controlled field position.
- Dylan Edwards finished with **268 run metres and eight tackle breaks**.
- Canterbury stayed competitive but could not break down Penrith's defence.

### Contract settlement

| Rank | Contract ID | Exact contract | Outcome | Settlement |
|---:|---|---|---|---|
| 1 | `P-131-C01` | Bulldogs +9.5 | **LOSS** | Bulldogs lost by 14 |
| 2 | `P-131-C04` | Under 40.5 | **WIN** | 34 total |
| 3 | `P-131-C03` | Over 40.5 | **LOSS** | 34 total |
| 4 | `P-131-C02` | Panthers -9.5 | **WIN** | Penrith won by 14 |
| — | Winner alias | Penrith | **WIN** | Penrith won 24-10 |

## Rank-1 loss audit

The issued central score examples included 24-16 and 24-18. Penrith actually scored **24**, so the main error was the Bulldogs offensive floor: they produced only 10.

The forecast correctly identified its #1 kill path:
> Canterbury's completion/field-position process collapses and Cleary creates a repeat-set avalanche.

Penrith's near-perfect completion and Cleary's territorial control broadly realised that adverse branch. The card also knew Penrith were the stronger team and correctly selected them as potential winner; the spread rank was a judgment that current absences plus Bulldogs recent defence made +9.5 more robust.

The loss does not by itself prove the process was defective. However, the audit shows the favourite's control floor deserved more weight than the prior upset/H2H narrative.

## Retrospective

| Preissue expectation | Actual driver | Difference | Knowability | Process grade | Defect class | Lesson/test | Method change |
|---|---|---|---|---|---|---|---|
| Penrith winner but Canterbury +9.5 central; low total | Penrith's 38/41 completion and defence produced a 14-point win while total stayed low | Total thesis correct; low-total assumption did not imply a close margin | This exact control/separation kill path was disclosed; no decisive late information was missed | `COMPLIANT` | `NONE — RANKING MISS` | Reinforce handicap decomposition: low total does not guarantee underdog cushion | **No rule/weight change** |

**Sources**
- Official NRL final/live blog: https://www.nrl.com/news/2026/08/28/friday-night-lights-sea-eagles-v-dragons-panthers-v-bulldogs/
- Official NRL team/availability preview: https://www.nrl.com/news/2026/08/25/panthers-v-bulldogs-cole-in-for-cogger-tuala-good-to-go/

---

# P-132 settlement — RC Vannes Sevens vs LOU Rugby Sevens

## Verified final

**RC Vannes Sevens defeated Lyon OU 17-10.**

Halftime was **10-5**. Total points: **27**. Margin: **7**.

### Contract settlement

| Rank | Contract ID | Exact contract | Outcome | Settlement |
|---:|---|---|---|---|
| 1 | `P-132-C04` | Under 35.5 | **WIN** | 27 total |
| 2 | `P-132-C02` | Lyon +9.5 | **WIN** | Lyon lost by 7 |
| 3 | `P-132-C03` | Over 35.5 | **LOSS** | 27 total |
| 4 | `P-132-C01` | Vannes -9.5 | **LOSS** | Vannes won by 7 |
| — | Winner alias | Vannes | **WIN** | Vannes won 17-10 |

## Retrospective

| Preissue expectation | Actual driver | Difference | Knowability | Process grade | Defect class | Lesson/test | Method change |
|---|---|---|---|---|---|---|---|
| Lower-scoring, close Vannes-favoured game | Vannes won by seven in a 27-point match | Central event shape matched strongly | Sparse sevens evidence was appropriately capped | `COMPLIANT` | `NONE` | Keep winner, margin and total separate in high-variance sevens | **No rule change** |

**Sources**
- Current match result: https://www.sofascore.com/rugby/match/rugby-club-vannes-lyon-olympique-universitaire-7s/POKcsHQxe
- Official SuperSevens event hub: https://supersevens.lnr.fr/etape/2026-2027/pau/masculin

---



# P-133 settlement — Arthur Géa vs Nishesh Basavareddy

## Verified final

**Nishesh Basavareddy defeated Arthur Géa 6-3, 6-1** in the 2026 US Open men's qualifying final round on Court 12 and advanced to the main draw.

Official ATP Tour result sources list Basavareddy `[32]` defeating Géa `[1]` **6-3, 6-1**.

Derived settlement values:
- total games: **16**;
- Basavareddy game margin: **+8**;
- Géa game margin: **-8**;
- sets: **2-0 Basavareddy**.

### Contract settlement

| Rank | Contract ID | Exact contract | Outcome | Settlement |
|---:|---|---|---|---|
| 1 | `P-133-C01` | Arthur Géa -2.5 games | **LOSS** | Géa lost the match and finished 8 games behind |
| 2 | `P-133-C03` | Over 22.5 games | **LOSS** | 16 total games |
| 3 | `P-133-C04` | Under 22.5 games | **WIN** | 16 total games |
| 4 | `P-133-C02` | Nishesh Basavareddy +2.5 games | **WIN** | Basavareddy won outright by 8 games |
| — | Winner alias | Arthur Géa | **LOSS** | Basavareddy won 6-3, 6-1 |

## Rank-1 loss and pregame-mistake audit

This was not a boundary miss. The realised match state was almost the inverse of the issued central thesis:

- the forecast preferred **Géa -2.5**; Basavareddy won by **8 games**;
- the forecast preferred **Over 22.5** as rank #2; the match ended at only **16 games**;
- the two contracts that won — **Under 22.5** and **Basavareddy +2.5** — were ranked #3 and #4 respectively;
- the potential winner, **Arthur Géa**, also lost.

### What was wrong in the pregame analysis

#### 1. The scenario tree was asymmetric

The issued tree contained:
- a **Géa straight-set control** branch;
- tight straight-set branches;
- three-set Géa wins;
- a **Basavareddy upset / long-match** branch.

It did **not** explicitly represent the ordinary possibility of a **Basavareddy straight-set control** result. That matters because the realised 6-3, 6-1 score simultaneously supports:
- Basavareddy +2.5;
- Under 22.5;
- Basavareddy outright;
while defeating both of the top-ranked contracts.

The underdog's winning path was therefore too tightly coupled to the forecast's long-match/Over branch. In a coherent best-of-three match tree, **either player can win quickly, win tightly, or win in three sets**.

#### 2. Opponent/competition adjustment was asserted more strongly than it was demonstrated

The card cited recent hard-court hold, break and return-point splits and called the Géa return profile the decisive matchup signal. But the supplied record did not show a transparent adjustment putting those samples on a common opponent-strength / competition-level basis.

That is important because raw hard-court rates assembled across ATP Tour, Challenger and qualifying opposition are not automatically exchangeable. Under the active tennis rules, broad surface rates are priors unless opponent/level continuity and current regime are reconciled.

This does **not** mean the pregame numbers were fabricated. It means their comparative interpretation was more certain than the documented transformation justified.

#### 3. The 6-of-7 Géa -2.5 cover observation was descriptive, not a causal mechanism

The forecast repeatedly highlighted that Géa had exceeded a -2.5 game margin in **six of seven recent hard-court wins**. That was a legitimate descriptive classification, but it should have remained secondary.

A margin record inside a winning run is strongly outcome-conditioned and does not independently explain why the same margin should persist against this opponent. Serve/return matchup, opponent strength, set-score distribution and current physical/competitive state should control the rank.

#### 4. The rank-1 kill path was too narrow

The stated kill path for Géa -2.5 focused mainly on:
- two close/tiebreak sets; or
- a three-set match whose set scores offset enough to keep Géa within +1/+2 games.

But **any Basavareddy win** defeats Géa -2.5, and a straight-set Basavareddy win was an ordinary adverse branch that deserved explicit representation. The strongest failure path should not have been framed primarily as “Géa wins but does not cover.”

### What the pregame analysis did correctly

- Event identity, surface, format, round and participants were frozen correctly.
- It correctly avoided inventing H2H: this was their first meeting entering the match.
- It correctly disclosed unknown operator retirement/walkover treatment rather than assuming settlement terms.
- It recognised that a short straight-set match could land Under 22.5, although it attached that branch almost entirely to **Géa** control rather than allowing either player to dominate.
- It did not publish an invented numerical probability.

No reliable official point-by-point or full match-stat block was recovered in this settlement pass, so the retrospective does **not** invent ace, break-point, serve-percentage or return-point explanations for the final.

## Retrospective

| Preissue expectation | Actual driver | Difference | Knowability | Process grade | Defect class | Lesson/test | Method change |
|---|---|---|---|---|---|---|---|
| Géa stronger central hard-court state; Géa -2.5 first; long/competitive resistance made Over 22.5 second | Basavareddy won decisively in straight sets, 6-3, 6-1; 16 total games | Side, handicap and total-tree orientation were materially wrong; winning contracts occupied ranks 3 and 4 | The omitted Basavareddy straight-set branch and the lack of demonstrated opponent-level adjustment were preissue modelling issues, not unknowable late information | `PROCESS_DEFECT` | `SCENARIO-TREE ASYMMETRY / OPPONENT-ADJUSTMENT NOT DEMONSTRATED / OUTCOME-HEURISTIC OVERWEIGHTING` | Enforce the existing tennis shared-match-tree rule: represent straight-set control for **both** players, shrink raw surface rates across differing opponent/level populations, and keep recent cover counts descriptive only | **Enforce existing controls; no single-match coefficient change** |

## Evaluation provenance

The forecast artifact was first supplied to this workspace **after the match had finished**. Therefore the settlement is retained for descriptive learning, but P-133 is classified:

`E1-Q-LATE_IMPORT`

It must be excluded from prospective performance, calibration, model-promotion and prospective-test counts unless an earlier immutable pre-result artifact is subsequently supplied and verified.

**Sources**
- ATP Tour final qualifying report: https://www.atptour.com/en/news/us-open-2026-qualifying-final
- ATP Tour US Open results: https://www.atptour.com/en/scores/current/us-open/560/results?matchType=singles
- ATP Tour Los Cabos title report for the pregame factual cross-check: https://www.atptour.com/en/news/gea-shapovalov-los-cabos-2026-final

---

# P-134 settlement — Cape Verde vs Guinea

## Verified final

**Guinea defeated Cape Verde 81-61.**

Official FIBA game data:
- quarter scores: Cape Verde 16-18-16-11; Guinea 23-23-17-18
- biggest lead: **Guinea 20**
- Guinea led for **35:05**
- FG: Cape Verde **32%**, Guinea **42%**
- 2PT: Cape Verde **37.1%**, Guinea **52.8%**
- 3PT: both **25%**
- FT: Cape Verde **70%**, Guinea **86.2%**
...
| Rank | Contract ID | Exact contract | Outcome | Settlement |
|---:|---|---|---|---|
| 1 | `P-134-C01` | Cape Verde +10.5 | **LOSS** | Cape Verde lost by 20 |
| 2 | `P-134-C04` | Under 150.5 | **WIN** | 142 total |
| 3 | `P-134-C03` | Over 150.5 | **LOSS** | 142 total |
| 4 | `P-134-C02` | Guinea -10.5 | **WIN** | Guinea won by 20 |
| — | Winner alias | Guinea | **WIN** | Guinea won 81-61 |

## Rank-1 loss and pregame-mistake audit

This is the clearest ranking defect in the sweep.

The issued forecast explicitly identified the Guinea separation branch:
- Cape Verde loses the rebounding/paint battle without **Edy Tavares**;
- Ivan Almeida is forced into difficult creation;
- Guinea's stronger Window 4 creator pool generates repeated high-value shots;
- margin expands into roughly **12-18 points**.

It also explicitly noted:
- Tavares was absent;
- Guinea's current Window 4 roster was more talented than earlier versions;
- Guinea's rebounding edge created a real blowout branch.

Yet rank #1 Cape Verde +10.5 was still justified heavily by:
- Cape Verde covering that threshold in 5/7 prior qualifier games;
- Guinea producing 11+ margins only 3/7;
- older H2H favouring Cape Verde.

The final followed the current-regime separation mechanism even more strongly than the card's own adverse examples: **Guinea +20**, with a major 2PT efficiency gap and Cape Verde held to 61.

### What should have been ranked differently

Given the information already known preissue:
- Guinea -10.5 should not have been automatically promoted to #1 solely from the eventual result;
- but **Cape Verde +10.5 should not have held MEDIUM-HIGH evidence / rank #1** while the current-regime branch materially contradicted the historical cover/H2H prior.
- At minimum the spread pair should have been much closer and evidence on Cape Verde +10.5 reduced.

This is exactly the type of error covered by the existing regime-dominance control: current participant/regime evidence must be explicitly reconciled against stale priors and old H2H.

## Retrospective

| Preissue expectation | Actual driver | Difference | Knowability | Process grade | Defect class | Lesson/test | Method change |
|---|---|---|---|---|---|---|---|
| Guinea winner by modest margin; Cape Verde +10.5 most robust; Under slight lean | Guinea led most of the game, won by 20, shot 52.8% on 2PT while Cape Verde shot 37.1% on 2PT; total still Under | Total read correct; spread ranking materially underweighted the exact current-regime separation path | Tavares absence, Guinea roster upgrade and separation mechanism were already known and written into the forecast | `PROCESS_DEFECT` | `REGIME-DOMINANCE / KILL-PATH UNDERWEIGHTING` | Reinforce `L-029`: current participant regime cannot be acknowledged then effectively overruled by old H2H/cover counts without a defensible mixture rationale | **Enforce existing control; no single-game coefficient change** |

**Sources**
- Official FIBA game page: https://www.fiba.basketball/en/events/fiba-basketball-world-cup-2027-african-qualifiers/games/127222-CPV-GUI

---

# Open-state audit — not settled

## P-126 — Sikkim Aakraman FC vs Sikkim Boys Club

**Status:** `OPEN — PREGAME`

The original log carried a schedule conflict. At this audit, current score feeds list the next match for **29 August 2026 at 05:30 UTC**, which is **15:30 Australia/Melbourne**. Because the federation/competition field-owner page for the exact fixture was not recovered, the schedule remains explicitly field-owner-unresolved rather than promoted to a fully official fact.

No result is graded.

Current corroborating source:
- https://www.sofascore.com/football/team/sikkim-aakraman/1072608

## P-135 — Unión de Santa Fe vs Sarmiento

**Status:** `OPEN — LIVE`

ESPN exposed **0-0 at 2'** during the audit and displayed starting formations/lineups. The event has therefore crossed from the original unresolved-start state into a live state.

Under the Sports Research rules, a live event is not settled and the original pre-start contracts are not retrospectively re-ranked here.

Current state source:
- https://africa.espn.com/football/match/_/gameId/401841525/sarmiento-junin-union-santa-fe

## P-136 — James Duckworth vs Arthur Fery

**Status:** `OPEN — PREGAME`

The original record schedules the match **not before 08:30 Australia/Melbourne on 29 August**. Current Tennis.com data still labels the semifinal **Upcoming**.

No result is graded.

Current source:
- https://www.tennis.com/tournaments/winston-salem-open/matches/j-duckworth-vs-a-fery-2026-08-28

---

# Data-quality and provenance correction — P-133

The 08:15 settlement sweep correctly observed that the then-available continuation jumped from `P-132` to `P-134`.

The user subsequently supplied a forecast artifact identifying the missing canonical record as:

**P-133 — Arthur Géa vs Nishesh Basavareddy — 2026 US Open Men's Qualifying Final.**

The canonical gap is therefore **administratively resolved** and the record has been inserted back into sequence without changing P-134 or any later ID.

However, the current workspace first received/demonstrated this P-133 artifact **after the official final**. The embedded pregame timestamp is preserved as claimed metadata but is not, by itself, proof of pre-result storage.

**Evaluation treatment:** `E1-Q-LATE_IMPORT`.

If an earlier immutable pre-result copy/hash is later supplied, append a provenance correction; do not rewrite this one.

---

# Learning append — 2026-08-29 sweep

These are retrospective observations inside the prediction log. They do **not** automatically modify forecast weights.

| Scope | Evidence | Learning | Status / action |
|---|---|---|---|
| Tennis | P-124 | A match-winner edge can coexist with a strong opponent set/cushion branch; first-set and 2-0 rows need their own evidence and must not inherit winner confidence | **Reinforce existing tennis shared match-tree control** |
| Ice hockey | P-125 | Large SOG edge does not force a high total; unverified goalie/finishing state should widen total uncertainty | **Reinforce existing hockey shot-vs-goal and goalie-mixture controls** |
| Basketball | P-127 | When an OT total loses, first separate regulation result from OT; here regulation was already 160 vs U158.5 | **Settlement/retrospective discipline; no new rule** |
| Rugby union | P-128 | Broad recent Over hit counts and league scoring averages are insufficient to control a total when matchup-native scoring-process evidence is thin and no dedicated module exists | **Candidate `C-P128-RU-TOTAL-MECHANISM`; do not promote from one game** |
| Rugby league | P-129 | A favourite-only blowout can clear a total even while the underdog contribution is suppressed; short fields/errors can make margin and Over rise together | **Enforce existing possession-native blowout rule** |
| Soccer | P-130 | Regulation and extra time must remain separate settlement endpoints; unknown corner provider leaves the niche row formally unsettleable | **Reinforce existing endpoint/provider gates** |
| Rugby league | P-131 | Low total does not imply a close margin; elite completion/territorial control can produce a multi-score favourite win in a low-scoring game | **Reinforce handicap decomposition / low-total≠close-margin control** |
| Rugby sevens | P-132 | Winner, total and handicap remained correctly separable in a high-variance format | **No new rule** |
| Basketball | P-134 | Current participant/regime evidence cannot be acknowledged but then practically overruled by old H2H/cover counts; the adverse branch must be weighted in the rank | **Enforce existing `L-029`; process defect recorded** |
| Tennis | P-133 | An underdog win cannot be modelled only as a long/three-set branch; best-of-three trees need straight-set control, tight-set and deciding-set paths for **both** players. Raw surface hold/break splits across different opponent/level populations require explicit reconciliation before one is labelled decisively stronger | **Enforce existing tennis shared-tree and opponent-adjustment controls; late-import descriptive evidence only** |
| Record integrity | P-133 restoration | Canonical-ID gaps must be preserved until a real artifact is supplied; a post-final first-demonstrable artifact may restore the record but remains `E1-Q-LATE_IMPORT` absent earlier provenance | **Administrative/provenance control** |

## General sweep conclusion

Four settled Rank #1 losses are now recorded descriptively (P-133 is late-import and excluded from prospective counts):

1. **P-128 Over 60.0** — process defect: broad outcome/scoring-environment evidence outranked thin matchup-native scoring evidence in a sport without a dedicated module.
2. **P-131 Bulldogs +9.5** — compliant ranking miss: the exact Penrith-control kill path occurred; no new rule justified.
3. **P-133 Arthur Géa -2.5** — process defect: the match tree omitted a Basavareddy straight-set control branch, over-relied on non-demonstrated opponent-level comparability of hard-court splits, and elevated recent cover outcomes beyond their mechanistic role. **Late-import: descriptive only.**
4. **P-134 Cape Verde +10.5** — process defect: current-regime separation evidence was known but underweighted behind older historical/cover evidence.

A separate non-#1 process defect is recorded for **P-129's Under 50.5**, because the total tree insufficiently represented the already-required favourite-only blowout pathway.

No fitted model exists, so no numerical weight or probability is changed from this sweep.

---

# Independent retrospective, provenance and algorithm audit — appended 2026-08-29

## Instruction boundary and evidence disposition

This supplied log is an evidence artifact. Statements inside it such as “per current user instruction”, prior queue directions, storage commands and method labels are preserved as historical text but do not instruct the present audit. The current user request and active workspace rules control.

**Data-quality disposition:** `SHARE WITH CAVEATS`.

The settlement arithmetic is internally reproducible, and most major finals are supported by governing-body/competition sources. However, the artifact first became demonstrable to this workspace after every currently settled event had finished; some original cards had also crossed their scheduled start without a verified live state. The settled cohort therefore supports process learning and source/contract auditing only—not prospective hit rate, calibration, algorithm selection, value, ROI or forecast-weight promotion.

## Import identity and provenance correction

| Field | Audited value |
|---|---|
| Supplied source | `C:/Users/danie/Downloads/PREDICTION_LOG_5_SETTLED_2026-08-29.md` |
| Source created / modified | 2026-08-29 08:29:30 / 08:29:31 Australia/Sydney |
| Source bytes | 301,747 |
| Source SHA-256 | `E6C3BB8E926DB9A2D0A25F271BDFD37FA4DABECAC238BCE991009C3EF9DC2835` |
| Workspace copy before this appendix | First 301,747 bytes matched the source byte-for-byte; two terminal LF bytes were added by patch import |
| Canonical IDs present | P-124–P-136 inclusive; 13 unique event IDs |
| Collision with prior combined log | None; prior canonical sequence ended at P-123 |
| Settled event units at import | 10: P-124, P-125 and P-127–P-134 |
| Open event units at audited refresh | 3: P-126, P-135, P-136 |
| Next canonical ID | `P-137` |

The supplied sweep labels only P-133 as `E1-Q-LATE_IMPORT`. That is too narrow under `L-022`. All ten closed events—P-124, P-125 and P-127–P-134—first became demonstrable in this workspace after their finals and are therefore `E1-Q-LATE_IMPORT` unless an earlier immutable artifact is later supplied and verified. Their embedded issue/research times remain claimed metadata, not proof of pre-result storage.

Additional open-record provenance:

- **P-135:** the first demonstrable artifact arrived after kickoff. Its frozen pre-start ranks are performance-ineligible and must never be scored as a prospective pregame view. The attachment correctly issued no actionable live replacement.
- **P-136:** the supplied file became demonstrable at approximately 08:29:30 AEST, before the match had begun; Tennis.com still showed `Upcoming` on a rendered refresh after the 08:30 not-before time. P-136 may enter qualitative prospective evaluation from the demonstrable artifact time, subject to final identity/settlement gates.
- **P-126:** the artifact arrived before the currently favoured 15:30 AEST schedule branch, but conflicting 28-August feeds were never resolved by the field owner. Prospective eligibility remains `QUARANTINED — SCHEDULE IDENTITY UNRESOLVED` until the actual start chronology is established.

## Current open queue — verified refresh

| ID | Audited state | Current evidence | Queue action |
|---|---|---|---|
| P-126 | `OPEN — PREGAME / SCHEDULE-CONFLICT` | Current stronger branch: 2026-08-29 05:30 UTC / 15:30 AEST; no exact SFA field-owner fixture order recovered | Keep open; recheck SFA/competition source, participant orientation and live/final state before any settlement |
| P-135 | `OPEN — LIVE` | Rendered Sofascore refresh: Unión 1–0 Sarmiento at 33:33; Cristian Tarragona 18'; official LPF schedule had 19:00 Argentina / 08:00 AEST kickoff | Keep open; settle only from the final. Do not re-rank frozen pre-start contracts as live picks |
| P-136 | `OPEN — PREGAME / UPCOMING` | Rendered Tennis.com refresh after 08:30 AEST still showed `Upcoming`; ATP/event identity and semifinal round match | Keep open; refresh official ATP/event score before settlement |

No open record is settled in this audit. The next run must check these three IDs before appending P-137, close verified finals, preserve genuinely live/postponed states and leave any unverified niche statistic unsettleable.

## Settlement arithmetic — independently recomputed

| Diagnostic | Recomputed result | Use boundary |
|---|---:|---|
| Closed event units | 10 | Descriptive late-import cohort |
| Raw contract rows | **20 W / 19 L / 1 U** | 39 settled rows; dependent and not prospective accuracy |
| Rank #1 | **6–4** | 60.0%; no probability or market baseline |
| Rank #2 | **5–5** | No rank separation demonstrated |
| Rank #3 | **5–5** | No rank separation demonstrated |
| Rank #4 | **4 W / 5 L / 1 U** | Bottom slot is not a validated fade |
| Top-two rows | **11/20 W** | Correlated within events; not a portfolio return |
| Potential winner labels | **9–1** | P-130 is eventual/AET direction only, not a regulation-winner settlement |
| Proper-score eligible probabilities | **0** | No probabilities were issued |
| Price/value eligible rows | **0** | No validated probability plus complete same-time price/terms snapshots |
| Prospectively eligible settled rows | **0** | Every settled record was first demonstrable after final |

The raw 20–19–1 and 6–4 summaries are retained so the record is arithmetically transparent. They must not appear elsewhere as evidence that v2.4 or v2.5 achieved a forecast accuracy rate.

## Event-by-event retrospective

### P-124 — Ferguson vs Jiang — Ferguson 5-7, 6-4, 6-3

- **Outcomes:** R1 Ferguson ML W; R2 Ferguson first-set W L; R3 Jiang +5.5 games W; R4 Ferguson 2-0 L; winner Ferguson W.
- **What worked:** the match-winner and opponent-cushion combination came from a coherent close/three-set pathway.
- **What failed:** first-set and straight-set rows inherited too much confidence from Ferguson's overall edge and old same-venue openings. Jiang's live set-winning branch was already material.
- **State/provenance:** the nominal start window may already have crossed at the claimed 14:23 refresh and official live state was unavailable. This view is `STATE_INCONCLUSIVE` as well as late-import.
- **Action:** tennis first-set rows now require an opening-set sub-tree; full-match, first-set and 2-0 confidence cannot transfer automatically. No coefficient changes.

### P-125 — Canberra Brave vs Sydney Bears — Canberra 4-3

- **Outcomes:** R1 Sydney +1.5 W; R2 O8.5 L; R3 Canberra -1.5 L; R4 U8.5 W; winner Canberra W.
- **What worked:** the Canberra-winner/Sydney-cushion state was represented accurately.
- **What failed:** recent scoring and SOG upside were allowed to make the Over central even though goalie identity and conversion quality were unresolved. A 41–29 SOG edge still yielded only seven goals.
- **State/provenance:** scheduled start had crossed and no exact live score/period/clock was verified. This is a non-actionable state-limited view, not a valid pregame forecast.
- **Action:** `RULES_ICE_HOCKEY` now makes the shot-volume → shot-quality/finishing → goalie/special-teams/empty-net conversion chain explicit. This is a process clarification, not a total-direction weight.

### P-127 — Iran vs New Zealand — New Zealand 93-91 OT

- **Outcomes:** Iran +7.5 W; U158.5 L; O158.5 W; NZ -7.5 L; winner NZ W.
- **What worked:** preferred winner plus underdog cushion correctly described a close NZ win.
- **What failed:** the total centre was marginally low. Regulation ended 80-80, so the Under was already lost before overtime.
- **Knowability:** OT/late-foul risk was named, but retrospective attribution must not blame OT for a threshold already crossed in regulation.
- **Action:** basketball settlement now records regulation and OT contributions separately. No forecast rule or coefficient changes from this boundary miss.

### P-128 — Auckland vs Bay of Plenty — Bay of Plenty 22-19

- **Outcomes:** O60.0 L; Auckland +4.5 W; U60.5 W; Bay -4.5 L; winner Bay W.
- **What worked:** the close-margin and Bay-winner branches were correct.
- **Process defect:** broad recent Over counts and a competition scoring average outranked thin current matchup-native evidence. Official teams were not directly recovered; territory, opposition-22 entries, set piece, breakdown, discipline, try conversion and goal-kicking were not documented strongly enough to support Rank #1 Over.
- **Action:** `RULES_RUGBY_UNION.md` is now an active qualitative module and `C-PL6-RU-TOTAL-MECHANISM` is future-only. P-128 cannot supply a fitted weight because it is one late-import event.
- **Source caveat:** RugbyPass supports the score/scoring sequence as reputable specialist evidence; an accessible field-owner match report was not recovered in this pass.

### P-129 — Manly vs Dragons — Manly 44-10

- **Outcomes:** Manly +10.5 W; U50.5 L; O50.0 W; Dragons -4.5 L; winner Manly W.
- **What worked:** side/winner ranking correctly identified the underdog outright-upset branch.
- **Process defect on Rank #2:** the Under rationale made 51+ depend too heavily on both teams scoring. Fifteen Dragons errors and 62% completion created repeated short fields; Manly supplied 44 points by itself.
- **Action:** the already-active possession-native blowout rule is now an explicit mandatory favourite-only total stress test. This is enforcement of known logic, not retrospective promotion of Overs.

### P-130 — Beitar Haifa Yakov vs Hapoel Bnei Arrara Ara — 1-1 regulation; Beitar 3-1 AET

- **Outcomes:** Beitar 1X W; 1H O0.5 W; regulation O2.5 L; corners U; eventual winner Beitar directionally correct.
- **What worked:** regulation non-loss and first-half goal branches.
- **Integrity point:** extra-time goals cannot settle the regulation total or a regulation winner. “Potential winner” is only an AET/event direction here because no regulation-winner endpoint was frozen.
- **Source caveat:** the Israeli FA exact current match record was not recovered. PGLive and Tips.GG agree on 0-1 HT and 1-1 regulation, while PGLive reports 3-1 AET. Treat score/phase fields as `PROVISIONAL — SECONDARY CORROBORATION`; the corner row remains U despite other aggregators displaying a count.
- **Action:** soccer rules now require the potential-winner endpoint to be explicit and forbid upgrading aggregator niche counts after the event.

### P-131 — Penrith vs Bulldogs — Penrith 24-10

- **Outcomes:** Bulldogs +9.5 L; U40.5 W; O40.5 L; Penrith -9.5 W; winner Penrith W.
- **What worked:** Penrith winner and low-total shape.
- **Ranking miss, not new defect:** the forecast named Penrith's completion/field-position avalanche as the Rank #1 kill path; Penrith completed 38/41 sets and separated by 14. A low total did not produce a close margin.
- **Action:** rugby-league rules now make the low-total separation branch mandatory. Do not infer an automatic favourite-spread weight from one result.

### P-132 — Vannes Sevens vs Lyon Sevens — Vannes 17-10

- **Outcomes:** U35.5 W; Lyon +9.5 W; O35.5 L; Vannes -9.5 L; winner Vannes W.
- **What worked:** winner, close margin and low total were separated correctly; the central branch matched.
- **Action:** no directional change. The new rugby-union/sevens module preserves sevens-specific restart, turnover, open-space, card, recovery and qualification branches and keeps sevens separate from 15s and league.

### P-133 — Géa vs Basavareddy — Basavareddy 6-3, 6-1

- **Outcomes:** Géa -2.5 L; O22.5 L; U22.5 W; Basavareddy +2.5 W; winner Géa L.
- **Process defect:** the tree modelled Basavareddy's upset mainly as a long/three-set state and omitted an ordinary Basavareddy straight-set control branch. Raw hard-court rates across ATP/Challenger/qualifying opposition lacked a demonstrated common opponent/level adjustment. Géa's 6/7 cover count inside recent wins was outcome-conditioned and the Rank #1 kill path was too narrowly framed as a Géa non-covering win.
- **Action:** `L-031` two-sided branch completeness and `L-032` outcome-conditioned-stat quarantine are promoted process controls; `C-PL6-TEN-BIDIRECTIONAL-TREE` remains a zero-count future candidate. No hindsight reversal or coefficient is installed.

### P-134 — Cape Verde vs Guinea — Guinea 81-61

- **Outcomes:** Cape Verde +10.5 L; U150.5 W; O150.5 L; Guinea -10.5 W; winner Guinea W.
- **What worked:** Guinea winner and lower-total branch.
- **Process defect:** the card knew Edy Tavares was absent, Guinea's current roster was stronger and paint/rebounding separation was plausible, yet old H2H and historical cover counts retained Rank #1/MEDIUM-HIGH control. The adverse branch was named but not reconciled into the evidence grade.
- **Action:** `L-029` is enforced through new `L-033`: a supported current-regime kill path must be given an explicit mixture rationale or the confidence/ordinal language must narrow. No automatic Guinea-spread promotion follows.

## Cross-sport findings and implemented changes

| Finding | Evidence | Implemented control | Forecast-weight status |
|---|---|---|---|
| Two-sided scenario completeness | P-133; reinforced by P-124 | Ordinary control/win paths for both sides; kill path includes supported opponent-win states | `PROMOTED_PROCESS`, no coefficient |
| Outcome-conditioned counts are not independent evidence | P-128, P-133, P-134 | Disclose conditioning/denominator; keep exposure/rate mechanisms primary | `PROMOTED_PROCESS`, no coefficient |
| Named adverse branches require ranking reconciliation | P-129, P-134; P-131 contrast | Explain qualitative mixture or lower evidence/narrow ranks | `PROMOTED_PROCESS`, no coefficient |
| State and provenance outrank outcome correctness | P-124, P-125, P-130, P-135 and all settled imports | Non-actionable/late-import quarantine; claimed timestamps do not create prospective status | Existing `L-022/L-026` enforced |
| Rugby codes require distinct mechanisms | P-128, P-132 | Dedicated qualitative 15s/sevens module; league remains separate | Architecture/process only |

The governing method is now `MDS-2026.08.29-v2.5`. The version changes representation, source/state discipline and scenario completeness only. No H0 dataset exists, no numerical model is fit, no probability is generated or published, and no result from this late-import cohort changes a fitted weight.

## Source audit and future retrieval lanes

| Source/lane | Field role | Audit disposition |
|---|---|---|
| FIBA exact event pages | Basketball identity, quarters, box score, final and lead/margin fields where exposed | Retain as field-owner `CANDIDATE / RESEARCH ONLY`; no blanket automated ingestion approval |
| NRL official live reports/team pages | Rugby-league teams, state, final and named match statistics | Retain as official field-specific lane |
| ATP Tour results plus official tournament schedule | Tennis draw/round/order, score and final | Preferred field-owner lane; Tennis.com is a current specialist cross-check |
| World Rugby Laws | Union/sevens rules, scoring and variations | New authoritative laws lane; competition regulations still required |
| LNR official SuperSevens hub | Stage, schedule, tournament reporting and results where exposed | New field-owner sevens lane |
| NZR/provincial-union/NPC official pages | Fixture, team sheet, late change and final where exposed | Preferred future NPC lane; not fully accessible for P-128 in this pass |
| RugbyPass | Defined rugby score/scoring sequence and specialist stats | Reputable specialist corroboration only; no official/H0 promotion |
| Ice Hockey News Australia plus linked game card | AIHL final, periods and SOG for P-125 | Reputable specialist/research lane pending direct AIHL field-owner access |
| LPF official schedule | Argentine fixture time/competition identity | Field-owner schedule lane; live score/final still requires official match centre or corroboration |
| The Away End and Sikkim Express | Sikkim fixture/results and local reporting, with Sikkim Express quoting SFA | Useful discovery/corroboration; cannot resolve the exact P-126 schedule without field-owner confirmation |
| Israeli FA | Preferred Israel Cup identity/final source | Exact P-130 record not recovered; secondary score remains provisional |

No source is promoted to `APPROVED FOR FEATURE` or `APPROVED FOR H0` by this audit. Access/use terms, coverage, known-at reconstruction, corrections, stable identifiers and provider definitions remain unresolved.

## Required next-run process

1. Read the combined log's top controlling snapshot; it alone controls P-126/P-135/P-136 and next ID P-137.
2. Refresh each open event from its field owner or the general two-source fallback. Settle only verified finals and preserve exact regulation/OT/ET/set/phase/provider boundaries.
3. Keep P-126 schedule eligibility quarantined until actual chronology is resolved; never infer it from a date label.
4. Treat P-135's pre-start rows as post-start-first-demonstrable and performance-ineligible; use the final only for process learning.
5. Settle P-136 from the official ATP/event final and exact game/set totals; it is the only current open row with a demonstrable pre-start artifact at this audit.
6. Apply `MDS-2026.08.29-v2.5`, including two-sided branch completeness, outcome-conditioned-stat quarantine, supported-adverse-branch reconciliation and the new rugby-union/sevens module.
7. Append settlement, process grade, source state and learning disposition; do not update weights from a single result or from any late-import record.
