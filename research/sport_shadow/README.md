...
| Basketball (`nba`, `wnba`, `nbl`) | League margin and total, with their SDs | Ridge offence/defence ratings. Normal margin and total, with no tie. Widths come from earlier out-of-sample residuals | NBA (2013–15 and 2023–26) and WNBA (2022–26): results and totals better than A0 and TB-1. **NBL (2026-09-26(e), research/predictability_2026-09-26):** 2025-26 results better than A0 and TB-1; 2024-25 results not significant; totals better in 2024-25 only |
...
| Rugby league (`nrl`) and rugby union (`union`, any ESPN path or CSV) | As basketball | As American football | **NRL 2026 (2026-09-26(e)):** results not significant (−0.0273, +0.0003); margin RPS better; totals no better. Rugby union: no |
